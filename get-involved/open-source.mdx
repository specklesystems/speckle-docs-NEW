...
<Note>
  Some enterprise-only capabilities are not developed in public repositories. When that is the case,
  public documentation still explains availability and usage, while deployment details are provided
