...
- Your organization has already **allowlisted Manager** for controlled deployment of legacy connectors.
...
<Tip>
  If you're unsure whether you still need Manager, check with your IT or project
  team.
</Tip>
...
<AccordionGroup>
  ...
  <Accordion title="IT had to allowlist various URLs for Speckle to function, do they remain the same?">
  ...
  <Accordion title="How are connectors deployed if not through manager?">
    Connectors are available at https://app.speckle.com/connectors. You can
    download them and install them manually.
  </Accordion>
  <Accordion title="Manager used to manage my local accounts for working with scripts run locally.">
    ...
    behaviour doesnt chnage but anticipates you have at least one connector
    installed. You can still use our SDKS with a Personal Access Token in place
    of local accounts.
  </Accordion>
</AccordionGroup>
