<AccordionGroup>
  ...
  <Accordion title="What happens if i remove a editor seat from a user who is a project collaborator?">
    They will remain a project team member but their role will be downgraded to **can view**.
  </Accordion>
  <Accordion title="What happens if i remove a editor seat from a user who is a workspace member?">
