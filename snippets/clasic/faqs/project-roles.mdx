<AccordionGroup>
  <Accordion title="Can non-workspace members have a project role?">
    ...
    security settings. If a user is added to a project with the **Can edit**
    role, they are granted editor-level project permissions. If they are not
    already a workspace member, they are added as a Guest.
  </Accordion>
