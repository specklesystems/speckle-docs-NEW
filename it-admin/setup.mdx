...
<Warning>
  There is no separate 2026.9 announcement for IT administrators. For dates, compatibility mode, and
  the connector upgrade window, see [IT administration for 2026.9](/next/it-admin/introduction).
</Warning>
