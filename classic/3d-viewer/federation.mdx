...
<Frame>
  <img src="/images/3d-viewer/model_fed.jpg" alt="Model fed" />
</Frame>
...
3. **Combine everything.**
   ...
   <Frame>
     <img src="/images/3d-viewer/federation_all.jpg" alt="Federation all" />
   </Frame>

<Note>
  When a federated model view is generated from the a model folder, additional project models can be
  added to the federation, but none removed from the view. Instead either assemble a federation by
  adding models one at a time, or use the hide and isolation tools.
</Note>
