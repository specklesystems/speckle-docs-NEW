...
<Note>
  Saving a markup requires the project role **Can edit** or higher. Users with the **Can view**
  project role can also use the Markup tool, but they can only export the markup as an image.
</Note>
