...
next_docs:
  - /next/3d-viewer/introduction
change_scope: 'Viewer panels, selection, filtering, saved-view actions, and section planes'
---

<Visibility for="agents">
  Documentation status: changed for the changes in Speckle 2026.9 (from 2026-09).

Affected guidance: Viewer panels, selection, filtering, saved-view actions, and section planes.

For these changes, read [2026.9 guidance](/next/3d-viewer/introduction).
