...
<Steps>
  ...
  <Step title="Install Connectors">
    ...
    <Frame>
    ![install](/images/introduction/intro-short_power_bi.gif)
    </Frame>
...
<Frame>
       ![install](/images/introduction/intro-signing_up_for_revit_first_time.gif)
</Frame>
...
<Frame>
       ![install](/images/introduction/intro-publishing_into_speckle.gif)
</Frame>
  </Step>
</Steps>
