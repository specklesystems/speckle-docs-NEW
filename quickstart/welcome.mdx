...
description: "This documentation is your go-to resource for basic understanding of Speckle's platform and terminology, getting started guides to set up workspaces, projects, and connectors, and common answers to FAQs and troubleshooting tips."
...
<Frame>
  <img src="/images/introduction/intro-speckle-1.jpg" alt="connector-data" />
</Frame>
...
<Frame>
  <img src="/images/introduction/intro-speckle-2.jpg" alt="connectors" />
</Frame>
...
<Frame>
  <img src="/images/introduction/intro-speckle-3.jpg" alt="web_app_dev_platform" />
</Frame>
...
- **Get insights**  
  Create interactive dashboards with [Speckle Intelligence Dashboards](/analytics/intelligence-dashboards) or leverage the Power BI connector to analyze BIM and AEC data for stakeholders.
