...
<Note>
  On v2026.9, a new check starts with an empty object scope, and some property paths change.
  Existing checks that return empty results may need rebuilding. See [Data Validation in
