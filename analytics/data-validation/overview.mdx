...
<Tabs>
  <Tab title="Property Checker">
    ...
    **When to use:** Use Property Checker for quick, ad-hoc validation checks of individual properties within a dashboard.
  </Tab>
  ...
  <Tab title="Model Validation">
    ...
    **When to use:** Use Model Validation when you need to validate a single model against a full ruleset within Intelligence dashboards.
  </Tab>

  <Tab title="Automated Validation">
    **Automated Validation** is a Speckle Automate-powered facility that allows validation testing on any model change, deployed across all your models:
...
## Getting Started with Automated Validation (Fiormerly Model Checker)
...
You can create rules that check for property existence, pattern matching, numeric comparisons, and value validation. Rules are defined using the validation rules interface at [model-checker.speckle.systems](https://model-checker.speckle.systems).
</Accordion>
