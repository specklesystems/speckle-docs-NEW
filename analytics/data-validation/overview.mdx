...
<Note>
  On v2026.9, a new check starts with an empty object scope, some property paths change, and a rule
  ...
  See [Data Validation in v2026.9](/next/analytics/data-validation/overview).
</Note>
