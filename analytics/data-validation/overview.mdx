...
<Tabs>
  ...
  <Tab title="Model Validation">
    **Model Validation** is an Intelligence widget that checks a single model against a ruleset defined as many Property Checks:
    ...
    - Uses Automated Validation (Automate) under the hood for validation at scale
    - Enterprise feature
  ...
  <Tab title="Automated Validation">
    **Automated Validation** is a Speckle Automate-powered facility that allows validation testing on any model change, deployed across all your models:
    ...
    - Create and manage validation rulesets
    - Automatically validates on every model publish
    - Deployed across all models in your project
