...
<Note>
  ...
  can check an object against a related object such as a host wall. Existing checks that return
  empty results may need rebuilding. See [Data Validation in
  v2026.9](/next/analytics/data-validation/overview).
</Note>
