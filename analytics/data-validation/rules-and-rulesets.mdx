...
See [Filters — Numeric properties](/analytics/dashboards/filters#numeric-properties) for descriptions and a screenshot of the menu.

For **boolean** properties, use **Is true** and **Is false**.
...
In the UI, use **Is greater than**, **Is less than**, or **Is between**. In legacy TSV, the same checks use `greater than`, `less than`, and `in range`.
...
The checker save flow has been streamlined so creating and updating rules is more direct during authoring.
