...
Matching is case-insensitive in both modes. Use `is like` with wildcards for simple pattern matching, or use `/regex/` for complex validation. For substring matching without patterns, use `contains`.
