...
change_scope: 'Project standards are absent in 2026.9; author checks instead'
---

<Visibility for="agents">
  Documentation status: superseded for the changes in Speckle 2026.9 (from 2026-09).

Affected guidance: Project standards are absent in 2026.9; author checks instead.
...
<Note>
  2026.9 does not include project standards. Author checks instead. If your team already built
  Project standards, email [hello@speckle.systems](mailto:hello@speckle.systems). See [Data
  Validation in 2026.9](/next/analytics/data-validation/overview#project-standards).
</Note>
