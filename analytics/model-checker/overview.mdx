...
<Steps>
  <Step title="Access Model Checker">
    ...
    <Frame>
     <img src="/images/model-checker/signin.png" alt="install" />
    </Frame>
  </Step>
  <Step title="Select a project">
    ...
    <Frame>
     <img src="/images/model-checker/project-selection.png" alt="install" />
    </Frame>
  </Step>
  <Step title="Create a ruleset">
    ...
    <Frame>
     <img src="/images/model-checker/edit-ruleset.png" alt="install" />
    </Frame>
  </Step>
  <Step title="Add rules">
    ...
    <Frame>
     <img src="/images/model-checker/rules.png" alt="install" />
    </Frame>
  </Step>
  <Step title="Copy your ruleset URL">
    ...
    <Frame>
     <img src="/images/model-checker/copy.png" alt="install" />
     <img src="/images/model-checker/copied.png" alt="install" />
    </Frame>
  </Step>
  <Step title="Set up the automation">
    ...
    <Warning>
    Image: Automate configuration with Model Checker function
    </Warning>
  ...
  <Step title="Review results">
    ...
    <Frame>
     <img src="/images/model-checker/results.png" alt="install" />
    </Frame>
  </Step>
</Steps>
...
### Projects Page
When you first access Model Checker, you'll see a list of your Speckle projects. You can:
- Browse through your projects
- Search for specific projects
- Click on a project to view or create rulesets

<Warning>
Image: Projects list interface
</Warning>

### Project Rulesets Page
Each project has its own rulesets page where you can:
- View all rulesets for the project
- Create new rulesets
- Import rulesets from TSV files
- Edit, copy links, or delete existing rulesets

<Warning>
Image: Project rulesets page
</Warning>

### Ruleset Editor
The ruleset editor allows you to:
- Add, edit, and delete rules
- Organize rules within a ruleset
- Preview your ruleset structure
- Copy your ruleset URL

<Warning>
Image: Ruleset editor interface
</Warning>
