...
For number properties, the picker includes equality, inequality, **greater than**, **less than**, and a **between**
(minimum and maximum) condition. Enter numeric values in the fields the UI shows for the predicate you chose.
