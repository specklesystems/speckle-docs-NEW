...
<Note>
  In a **Model Viewer** that loads multiple models, you can mark one as a **context model** so dashboard filters do
  not isolate or hide it in the 3D view. See [Context models](/analytics/intelligence-dashboards#context-models) on
  the Dashboards overview.
</Note>
