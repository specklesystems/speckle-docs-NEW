...
description: "Step-by-step guides for quantity takeoff, portfolio analysis, and finding models by family or type."
---

Short step-by-step guides for common dashboard outcomes. For concepts and widget choices, see
[Dashboards](/analytics/intelligence-dashboards). Not sure which widget to add? See
[Choosing the right widget](/analytics/intelligence-dashboards#choosing-the-right-widget) on the Overview.
