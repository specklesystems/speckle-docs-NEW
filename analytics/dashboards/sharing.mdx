...
<Note>
  On a total-value colour chip, the assembly button includes objects that share the category but
  have no value. It starts off. Saving a scenario stores that choice.
</Note>
