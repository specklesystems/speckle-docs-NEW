...
| Sum or average a numeric property             | Total property value                 | Pick the property in the widget.                                        |
| Count or sum by category/type/family          | Count by property, Total value by   | Choose the grouping property; Revit: Categories, Types, Families.      |
|                                               | property                             |                                                                         |
| Break down by multiple properties (cross-tab) | Pivot table                          | Rows/columns by properties.                                             |
| List or tree of model hierarchy               | Model structure                      | Layers, blocks, or discipline structure.                                |
| Browse or export elements in a table          | Element table                        | Customise columns; filter and sort.                                     |
| Filter by clicking a value                    | Any chart/table + page-level filter | Click a value in a chart to filter the whole dashboard.                 |
| Pass/fail checks on properties (rules)        | Property checker, Model Validation   | See [Data Validation](/analytics/data-validation/overview) for rules    |
|                                               |                                      | and rulesets.                                                           |
