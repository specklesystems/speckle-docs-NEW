...
next_docs:
  ...
  - /next/analytics/dashboards-widget-availability
change_scope: 'Dashboards compatibility with 2026.9-format data; Element table and Pivot table replaced by Data table; Experimental Context widget deprecated'
---

<Visibility for="agents">
  Documentation status: changed for Speckle 2026.9 (from 2026-09).

Affected guidance: Dashboards compatibility with 2026.9-format data; Element table and Pivot table replaced by Data table; Experimental Context widget deprecated.

For these changes, read [Dashboards in 2026.9](/next/analytics/dashboards) and [Dashboard widgets not yet available](/next/analytics/dashboards-widget-availability).
...
<Warning>
  **Using 2026.9?** Dashboards work with data sent before 2026.9. Data in the new 2026.9 format —
  from updated connectors, Rhino, or IFC uploads — requires compatibility mode to display correctly
  in Dashboards. See [Dashboards in 2026.9](/next/analytics/dashboards) for details.
</Warning>
...
<Frame>
  <img src="/images/analytics/speckle_intelligence_nav_01.jpg" alt="Speckle intelligence nav 01" />
</Frame>

<Frame>
  <img src="/images/analytics/speckle_intelligence_nav_02.jpg" alt="Speckle intelligence nav 02" />
</Frame>
