...
<AccordionGroup>
  ...
  <Accordion title="How do dashboards relate to sync limits?">
    ...
    [Sync Usage](/workspaces/new-plans-faq#sync-usage) in the [New plans FAQ](/workspaces/new-plans-faq).
  </Accordion>
  ...
  <Accordion title="Can I pass configuration values via the URL?">
    ...
    Tell us more via the [Dashboards category](https://speckle.community/c/making-speckle/bashboards/79) on the
...
<AccordionGroup>
  <Accordion title="Can I make my own widgets?">
    ...
    [Dashboards category](https://speckle.community/c/making-speckle/bashboards/79) on the Speckle Community or
  ...
  <Accordion title="Can I build custom applications with Speckle dashboards?">
    ...
    [Build with Speckle](https://speckle.systems/build-with-speckle) describes how we partner to extend and embed Speckle. If you want
