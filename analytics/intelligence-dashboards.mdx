...
<AccordionGroup>
  ...
  <Accordion title="When does dashboard data update?">
    **[Product: please confirm or complete.]** If the model viewer uses "latest", when does data refresh (e.g. on
    load, on manual refresh, or when reopening the dashboard)?
  </Accordion>
  <Accordion title="What happens if a project or model I use is deleted?">
    **[Product: please confirm or complete.]** How does the dashboard behave when a referenced project or model is
    removed (e.g. broken widgets, message, or fallback)?
  </Accordion>
  <Accordion title="Can I use models from projects where I'm only a guest?">
    Yes, if you have access to the project you can add its models to a dashboard. **[Product: confirm any
    restrictions for guest project access.]**
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Can I export a dashboard or widget (e.g. PDF, image, or chart data)?">
    **[Product: please confirm or complete.]** Is export to PDF, image, or CSV/chart data supported? If so, where
    is it in the UI?
  </Accordion>
  <Accordion title="Why is my dashboard slow?">
    Large models, many widgets, or many data sources can slow the dashboard. Prefer pinning a version when you don't
    need live updates, and avoid an excessive number of widgets on one dashboard. **[Product: add any official
    performance guidance or limits.]**
  </Accordion>
  <Accordion title="How many models can I add to one dashboard?">
    **[Product: please confirm or complete.]** Is there a recommended or hard limit on Model Viewer widgets (or
...
<AccordionGroup>
  ...
  <Accordion title="Can I share a dashboard with someone outside my workspace?">
    **[Product: please confirm or complete.]** Are dashboards workspace-only, or is there public/embed/link-sharing
    for external viewers?
  </Accordion>
  <Accordion title="Is there a view-only or presentation mode?">
    Yes. The dashboard **view** URL (e.g. when opening a dashboard in view mode rather than edit) shows the
    dashboard without edit controls. Use the view link when you want to share a read-only version. **[Product:
    confirm how view vs edit links are surfaced in the UI and whether embed (e.g. iframe) is supported.]**
  </Accordion>
  <Accordion title="What happens to my dashboards if I leave the workspace?">
    **[Product: please confirm or complete.]** Are dashboards transferred, retained by the workspace, or lost when
    a user leaves?
  </Accordion>
  <Accordion title="Which applications have extra widgets?">
    ...
    sources. **[Product: add a definitive list or link to a widget catalog if one exists.]**
  </Accordion>
  <Accordion title="Can I use IFC models in dashboards?">
    **[Product: please confirm or complete.]** Can IFC (or other formats) be used as dashboard data sources? Any
    limitations once converted to Speckle?
  </Accordion>
  ...
  <Accordion title="Can I compare more than two versions at once?">
    **[Product: please confirm or complete.]** The Dual viewer widget compares two models. Is there support for
    comparing more than two versions in one widget or dashboard?
  </Accordion>
</AccordionGroup>
