...
<!-- IMAGE: Dashboard with Model Viewer and Element count visible -->
...
Your dashboard needs at least one model; the **Model Viewer** widget provides that data to every other widget. The model viewer displays your 3D model; a **Dual viewer** widget lets you compare two models side by side.
...
<!-- IMAGE: Filter chips at top of dashboard -->
...
<Note>
**When filtering becomes rules**: If you need reusable rules, pass/fail checks, or rulesets (e.g. "all doors must have a fire rating"), use the **Property Checker** or **Model Validation** widgets and define rules in the widget or in a ruleset. For rule syntax, rulesets, and automated validation, see [Data Validation](/analytics/data-validation/overview).
</Note>
