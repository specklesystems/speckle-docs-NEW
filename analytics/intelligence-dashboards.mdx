...
<Info>
  Dashboard widget guidance maps to the Classic validation docs: [Classic Data
  Validation](/classic/analytics/data-validation/overview). For frontend-3 checks and
  standards guidance, use [Current Data
...
| Run pass/fail rules (e.g. doors must have fire rating)                | Property checker, Model Validation         | For widget-first guidance, see [Classic Data Validation](/classic/analytics/data-validation/overview). For frontend-3 checks/standards, see [Current Data Validation](/analytics/data-validation/overview). |
