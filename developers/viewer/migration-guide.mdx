...
- [_ObjectClicked_](/developers/viewer/viewer-api#viewerevent) and [_ObjectDoubleClicked_](/developers/viewer/viewer-api#viewerevent) events now have their picked objects filtered by a default 
