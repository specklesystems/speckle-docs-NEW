...
<Tip>
  When building a BVH, three-mesh-bvh library needs a three.js geometry as input. This is that
  geometry. We don't use it for rendering.
</Tip>
...
<Warning>
  ...
  [shapecast](/developers/viewer/acceleration-structure-api#shapecast) already call this function
  implicitly.
</Warning>
