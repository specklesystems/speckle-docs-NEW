---
title: 3D Viewer
description: Introduction to the Speckle Viewer architecture built on three.js. Learn about viewer-core features like automatic batching, BVH acceleration, and instanced rendering, plus the extensible extension system for custom functionality.
---
...
<Frame>
  <img src="/images/developers/viewer/viewer-core.png" alt="Viewer core" />
</Frame>
...
<Frame>
  <img src="/images/developers/viewer/extensions_core.png" alt="Extensions core" />
</Frame>
...
<Note>
  Probably the most important aspect with extensions, is that you can develop your own! More details
  on this topic will follow in a dedicated chapter.
</Note>
