...
<Tip>
  ...
  [_setMaterial_](/developers/viewer/speckle-renderer-api#setmaterial) which calls this method
  internally.
</Tip>
...
<Tip>
  The viewer's [_MeshBatch_](/developers/viewer/batch-api#meshbatch) implementation of Batch uses
