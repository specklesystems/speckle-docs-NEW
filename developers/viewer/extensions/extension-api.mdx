---
title: Extension
description: Base class for all extensions. Extensions are created via [_createExtension_](/developers/viewer/viewer-api#createextension) method from the viewer instance.
---
...
Injection is automatically done when calling [_createExtension_](/developers/viewer/viewer-api#createextension)
