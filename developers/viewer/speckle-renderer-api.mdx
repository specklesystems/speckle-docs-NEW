...
<Warning>
By default the viewer filters the objects from [_ObjectClicked_](/developers/viewer/viewer-api#viewerevent) and [_ObjectDoubleClicked_](/developers/viewer/viewer-api#viewerevent) events the following way:
