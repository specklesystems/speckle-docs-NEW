...
<CardGroup cols={2}>
  ...
  <Card
    title="Use SpeckleSharp in Grasshopper C#"
    icon="shapes"
    href="/developers/sdks/dotnet/guides/use-speckle-sdk-in-grasshopper-csharp"
  >
...
<CardGroup cols={3}>
  ...
  <Card
    title="Installation"
    icon="download"
    href="/developers/sdks/dotnet/getting-started/installation"
  >
...
<CardGroup cols={2}>
  ...
  <Card
    title="GitHub Issues"
    icon="github"
    href="https://github.com/specklesystems/speckle-sharp-sdk/issues"
  >
