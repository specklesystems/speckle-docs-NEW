...
<Note>
  Property names vary by connector and host app. Inspect a sample object in the Speckle viewer or
  use [Find objects by property](/developers/sdks/dotnet/guides/finding-and-extracting-data) to
  discover the keys your model uses.
</Note>
