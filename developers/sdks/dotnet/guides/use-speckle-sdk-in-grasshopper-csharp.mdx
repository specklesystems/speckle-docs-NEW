...
**When to use it:** enrich Grasshopper geometry with SDK types before or alongside the connector. **Read next:** [Grasshopper Objects](/connectors/grasshopper/grasshopper-objects) for connector basics, then [Objects and traversal](/developers/sdks/dotnet/concepts/objects-and-traversal).
