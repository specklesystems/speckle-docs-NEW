...
<Info>
You don't need to understand this page to complete the [Quickstart](/developers/sdks/dotnet/getting-started/quickstart) — copy the bootstrap snippet once. This page explains what that snippet does, for when you need to customize it.
</Info>
