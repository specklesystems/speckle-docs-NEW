...
<AccordionGroup>
  <Accordion title="I'm writing a script — do I need this page?">
    No. Copy the bootstrap from [Scripts and Notebooks](/developers/sdks/dotnet/getting-started/scripts-and-notebooks) and resolve `IOperations` and `IClientFactory` from the static helper. You do not register your own services unless you integrate with a host container.
  </Accordion>
