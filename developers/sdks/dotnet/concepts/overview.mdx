...
<Warning>
Objects sent to the server but not referenced by any version are **orphaned** (also called zombie objects) — stored with an object ID but unreachable through the Speckle UI until a version references them.
</Warning>
