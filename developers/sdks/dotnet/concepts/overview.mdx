...
When you send or receive building-model data from .NET, Speckle uses **objects** (structured property graphs) instead of files. A **project** holds **models**; each **version** is a published snapshot others can open in the viewer.

**When to read this:** before deep dives into guides or API reference. **Read next:** [Send and Receive Paths](/developers/sdks/dotnet/concepts/send-and-receive-paths) to pick your send method.
...
<CardGroup cols={3}>
  ...
  <Card title="Quickstart" icon="rocket" href="/developers/sdks/dotnet/getting-started/quickstart">
    Full send → version → receive tour
  </Card>
