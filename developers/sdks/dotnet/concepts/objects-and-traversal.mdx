...
When you send or receive Speckle data in .NET, you work with **`Base`** objects — typed and dynamic properties, nested graphs, optional detachment, and **`displayValue`** for viewer visibility.

**When to read this:** before modeling data or walking a received graph. **Read next:** platform [Object Schema](/developers/data-schema/object-schema) for wire format, then [Finding and Extracting Data](/developers/sdks/dotnet/guides/finding-and-extracting-data) for filter recipes.
