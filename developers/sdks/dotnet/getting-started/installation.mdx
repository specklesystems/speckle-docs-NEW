...
When you add Speckle to a .NET app, you install NuGet packages, register the SDK once at startup, and optionally add `Speckle.Objects` for geometry types.

**When to read this:** before your first compile against Speckle.Sdk. **Read next:** [Scripts and Notebooks](/developers/sdks/dotnet/getting-started/scripts-and-notebooks) for copy-paste bootstrap, then [Authentication](/developers/sdks/dotnet/getting-started/authentication).
...
<CardGroup cols={3}>
  <Card title="Dependency Injection" icon="book" href="/developers/sdks/dotnet/concepts/dependency-injection">
    What AddSpeckleSdk registers — for connectors
  </Card>
  <Card title="Scripts and Notebooks" icon="terminal" href="/developers/sdks/dotnet/getting-started/scripts-and-notebooks">
    Copy-paste bootstrap and Send2
  </Card>
