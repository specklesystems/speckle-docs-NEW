...
After you authenticate, you use `IClient` to call Speckle Server — create projects, list models, publish versions, and check server capabilities. Build it from an `Account` via `IClientFactory` and dispose it when done.
