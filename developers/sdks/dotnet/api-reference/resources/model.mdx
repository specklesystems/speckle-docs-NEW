...
When you publish data to Speckle, you target a **model** within a project — for example "structural", "MEP", or "main".

**When to read this:** after creating a project, before sending or ingesting data. **Read next:** [VersionResource](/developers/sdks/dotnet/api-reference/resources/version) to publish a snapshot, or [Building Connector-Scale Sends](/developers/sdks/dotnet/guides/building-connector-scale-sends) for `SendPipeline`.
