...
Before you resolve `IOperations`, `IClientFactory`, or transport factories, call `AddSpeckleSdk` on your `IServiceCollection` once at startup. This page documents the method signature and what it registers — for the conceptual overview, see [Dependency Injection](/developers/sdks/dotnet/concepts/dependency-injection).
...
<CardGroup cols={2}>
  <Card title="Dependency Injection" icon="cubes" href="/developers/sdks/dotnet/concepts/dependency-injection">
    Conceptual overview and common patterns
  </Card>
  <Card title="Client" icon="code" href="/developers/sdks/dotnet/api-reference/client">
    Resolving IClientFactory and building a client
  </Card>
</CardGroup>
