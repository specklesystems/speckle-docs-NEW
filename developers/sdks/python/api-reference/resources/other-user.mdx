...
<Note>
  This method returns limited public profile information. Email addresses and other private
  information are not included. Use `client.active_user.get()` to access your own full profile.
</Note>
### user_search()
