...
<Info>
  The `ResourceCollection` object includes: - `items` - List of Version objects - `totalCount` -
...
<Warning>
  This operation is irreversible! The versions will be permanently deleted, though the referenced
  objects may still exist in the project.
</Warning>
### received()
...
<Card
  ...
  icon="server"
  href="/developers/sdks/python/api-reference/transports#servertransport"
>
