...
- `host` (str, optional) - The Speckle server URL including protocol. Defaults to `"https://app.speckle.systems"`
...
- `query` (str) - GraphQL query string (use `gql()` for proper formatting)

**Returns:** `Dict` - Raw GraphQL response
