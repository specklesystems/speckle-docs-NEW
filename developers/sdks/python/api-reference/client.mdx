...
<Info>
📚 **Complete API Documentation**: For detailed, auto-generated API reference documentation with all methods, properties, and parameters, visit the [specklepy API Documentation](https://specklepy.speckle.systems/specklepy/api/client/).
</Info>
