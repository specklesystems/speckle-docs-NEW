...
- `stream_id` (str, required) - Project ID
- `client` (SpeckleClient, optional) - Authenticated client
- `account` (Account, optional) - Account object
- `token` + `url` (str, optional) - Token and server URL pair
- `name` (str, optional) - Transport identifier
...
**Parameters:**
- `base_path` (str, optional) - Custom directory for database
- `app_name` (str, optional) - Application name. Default: `"Speckle"`
- `scope` (str, optional) - Database scope/purpose. Default: `"Objects"`
- `max_batch_size_mb` (float, optional) - Batch size in MB. Default: `10.0`
...
- [Operations](/developers/sdks/python/api-reference/operations) - Send and receive operations
- [SpeckleClient](/developers/sdks/python/api-reference/client) - Client setup