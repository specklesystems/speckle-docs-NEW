...
<Note>Provide **one** authentication method: `client`, `account`, or `token` + `url`.</Note>
...
<Warning>Data is lost when the application exits. Not suitable for production.</Warning>
