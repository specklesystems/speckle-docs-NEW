...
<Info>
Learn more about [Static vs Dynamic Properties](/developers/sdks/python/concepts/objects#1-static-vs-dynamic-properties) including type checking, required vs optional properties, and how to work with both types.
</Info>
