...
# Base allows dynamic properties
custom = Base()
custom.name = "My Object"
custom.data = [1, 2, 3]
custom.nested = Base(value=42)
```
...
<Accordion title="Models">
  **Models** are branches within a project, representing different variants or disciplines.
  ...
  - Examples: "main", "design-option-a", "structural", "MEP"
  - Each model has its own version history
  - Projects always have a "main" model by default
...
<CardGroup cols={3}>
  <Card title="ServerTransport" icon="server">
  ...
  <Card title="SQLiteTransport" icon="database">
  ...
  <Card title="MemoryTransport" icon="memory">
