...
# What type is this?
if obj.speckle_type == "Base":
    print("Type 1: Custom Data - direct property access")
    print(f"Name: {obj.name}")

elif obj.speckle_type.startswith("Objects.Geometry"):
    print("Type 2: Simple Model Data - check for properties dict")
    if hasattr(obj, "properties"):
        print(f"Properties: {obj.properties}")

elif obj.speckle_type.startswith("Objects.Data"):
    print("Type 3: Complex BIM Data - need defensive traversal")
    if hasattr(obj, "properties"):
        print("Has properties dict")
    if hasattr(obj, "displayValue"):
        print("Display value available")
```
...
Real-world data often mixes types:

```python lines icon="python"
# A collection might contain all three types
from specklepy.api import operations

obj = operations.receive(object_id, remote_transport=transport)

# Root might be custom
print(f"Project: {obj.name}")  # Custom property

# Some children are simple geometry
for geom in obj.geometry:
    print(f"Simple: {geom.speckle_type}")

# Others are complex BIM data objects
for element in obj.elements:
    if hasattr(element, "properties"):
        print(f"BIM: {element.name}")
```
