...
<Note>
  **Prerequisites:** This guide builds on traversal techniques. If you're new to navigating Speckle
  object graphs, start with [Traversing Objects](/developers/sdks/python/concepts/data-traversal) to
...
<Info>
  `encodedValue` is primarily for Rhino-to-Rhino workflows. For other platforms, use `displayValue`
  instead.
</Info>
...
<Note>
  **Instance Definitions Location:** Instance definitions are stored in the
...
<Note>
  **See Also:** For a comprehensive explanation of proxification, why overlapping hierarchies
  ...
  [Proxification](/developers/sdks/python/concepts/proxification).
</Note>
...
<Card
  title="Extracting Display Values"
  icon="cube"
  href="/developers/sdks/python/guides/working-with-proxies"
>
