---
title: 'Performance and Complex Patterns'
...
<Note>
  **Terminology Note:** Examples use property names like "category", "level", etc. for illustration.
  Real BIM data from connectors may structure these differently - Revit uses both direct properties
  AND proxy collections (e.g., `LevelProxy`, `CategoryProxy`). See [BIM Data
  Patterns](/developers/sdks/python/guides/bim-data-patterns) for connector-specific structures.
</Note>
