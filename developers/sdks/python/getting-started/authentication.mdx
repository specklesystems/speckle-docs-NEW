...
<Warning>
Store your token securely! Never commit tokens to version control.
</Warning>
...
```python lines icon="python" focus={5-6}
import os
from specklepy.api.client import SpeckleClient
...
<Tabs>
  <Tab title="Linux/macOS">
    ...
    export SPECKLE_SERVER="app.speckle.systems"
    ```
  ...
  <Tab title="Windows (PowerShell)">
    ...
    $env:SPECKLE_SERVER="app.speckle.systems"
    ```
  ...
  <Tab title="Windows (Command Prompt)">
    ...
    set SPECKLE_SERVER=app.speckle.systems
    ```
...
client = SpeckleClient(host="speckle.mycompany.com")
...
<CardGroup cols={2}>
  ...
  <Card title="Multi-User Apps" icon="users">
    **Implement OAuth 2.0 flow**
    ...
    For web apps where users authenticate themselves.
...
| `users:invite` | Invite users to projects |
