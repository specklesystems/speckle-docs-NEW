...
<CardGroup cols={3}>
  <Card title="Introduction" icon="csharp" href="/developers/sdks/dotnet/introduction">
  ...
  <Card title="Guides" icon="map" href="/developers/sdks/dotnet/guides/working-with-objects-and-detachment">
    Task-oriented recipes
  </Card>
