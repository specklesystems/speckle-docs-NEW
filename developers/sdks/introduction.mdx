...
| Computational design          | Python          |
| Data engineering and analytics | Python          |
| Desktop applications          | .NET            |
| Enterprise services           | .NET            |
| Connectors and integrations   | .NET            |
...
| **Transports** | How serialized objects move to storage (server, local cache, in-memory) | Python: [Transports](/developers/sdks/python/api-reference/transports) · .NET: [Send and Receive Paths](/developers/sdks/dotnet/concepts/send-and-receive-paths) |
