...
<Info>
  ...
  Schema](/developers/data-schema/overview); language-specific setup lives under
  [Python](/developers/sdks/python/introduction) and [.NET](/developers/sdks/dotnet/introduction).
</Info>
...
<Note>
  Both SDKs can call the same server, read the same projects, and work with the same object model.
...
<AccordionGroup>
  ...
  <Accordion title="Where is platform data structure documented?">
    [Data Schema](/developers/data-schema/overview) is language-agnostic. SDK **Concepts** pages
