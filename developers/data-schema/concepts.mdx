...
- **[Object Model](/developers/data-schema/object-model)** - The structure and fields of objects
- **[Geometry Model](/developers/data-schema/geometry-model)** - How geometry is stored
- **[Proxy Model](/developers/data-schema/proxy-model)** - How proxies work in detail
