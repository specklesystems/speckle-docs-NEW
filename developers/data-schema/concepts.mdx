...
```
Root Collection (top-level container)
│
├── Collection (e.g., "Level 1") ← parent
│   ├── Collection (e.g., "Walls") ← child of "Level 1", parent of wall objects
│   │   └── DataObject (wall) ← child of "Walls"
│   │       ├── Properties (name, material, height, etc.)
│   │       └── displayValue: [Mesh, ...] (geometry)
│   └── Collection (e.g., "Doors") ← child of "Level 1", parent of door objects
│       └── DataObject (door) ← child of "Doors"
│           ├── Properties (name, type, etc.)
│           └── displayValue: [Mesh, ...] (geometry)
│
└── Collection (e.g., "Level 2") ← sibling of "Level 1"
    └── ...
```
