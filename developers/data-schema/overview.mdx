...
graph TD
    ...
    B --> E["Collection: 'Level 1'"]
    E --> F["Collection: 'Walls'"]
    F --> G[DataObject<br/>wall with properties + displayValue]
    E --> H["Collection: 'Doors'"]
    H --> I[DataObject<br/>door with properties + displayValue]
    B --> J["Collection: 'Level 2'"]
    
    C --> K[RenderMaterial<br/>references objects by applicationId]
    C --> L[Level<br/>references objects by applicationId]
    C --> M[Definition<br/>stores geometry for Instances]
    
    D --> N[Views, Transforms,<br/>Analysis Results]
```
...
graph TD
    ...
    C --> F[Collections]
    F --> G[Objects]
    G --> H[Properties<br/>key-value pairs]
    G --> I[Geometry<br/>in displayValue]
    
    D --> J[Reference objects<br/>by applicationId]
    
    E --> K[Data package-wide data]
```
