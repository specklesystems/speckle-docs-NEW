...
2. **[Object Model](/developers/data-schema/object-model)** - How objects are structured and what fields they contain
3. **[Geometry Model](/developers/data-schema/geometry-model)** - How geometry is stored and organized
4. **[Proxy Model](/developers/data-schema/proxy-model)** - How proxies encode relationships
