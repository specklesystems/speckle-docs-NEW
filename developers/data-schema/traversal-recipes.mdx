...
- Review [Object Model](/developers/data-schema/object-model), [Geometry Model](/developers/data-schema/geometry-model), [Proxy Model](/developers/data-schema/proxy-model) for details
