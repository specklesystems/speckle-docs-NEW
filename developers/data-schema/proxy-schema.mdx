...
- **[Traversal Recipes](/developers/data-schema/traversal-recipes)** - How to navigate proxies and resolve references
- **[Connector Index](/developers/data-schema/connector-index)** - Connector-specific proxy usage
- **[Object Model](/developers/data-schema/object-schema)** - Review object structure
