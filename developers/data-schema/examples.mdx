...
- Review [Traversal Recipes](/developers/data-schema/traversal-recipes) for more patterns
- Check [Connector pages](/developers/data-schema/connector-index) for connector-specific examples
- See [Object Model](/developers/data-schema/object-schema) for data model details
