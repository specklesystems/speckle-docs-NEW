...
```
Object
├── id: content-based hash (unique identifier)
├── speckle_type: type name (e.g., "Objects.Data.DataObject")
├── applicationId: source application identifier
├── units: unit system (e.g., "meters")
├── name: human-readable name (for DataObjects)
├── properties: dictionary of key-value pairs (for DataObjects)
└── displayValue: array of geometry objects (for DataObjects)
```
