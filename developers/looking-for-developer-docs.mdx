...
<h4>
  <a href="/developers/viewer">Our Viewer API docs</a>{' '}
  <Tag tag="Current" />
</h4>

<h4>
  <a href="/developers/developers/server">Our server deployment docs</a>{' '}
  <Tag tag="Current" />
</h4>
...
<h4>
  <a href="/developers/automate">Our Speckle Automate docs</a>{' '}
  <Tag tag="Current" />
</h4>
