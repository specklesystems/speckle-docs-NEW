...
Now that you understand the concepts, let's examine the technical structure of objects. Every object in Speckle follows a consistent schema, regardless of which connector created it.
...
These extensions are documented in the [connector pages](/developers/data-model/connector-index).
...
- **[Geometry Model](/developers/data-model/geometry-model)** - How geometry objects are structured
- **[Proxy Model](/developers/data-model/proxy-model)** - How proxies encode relationships
- **[Traversal Recipes](/developers/data-model/traversal-recipes)** - How to navigate and process objects
