...
description: Overview of connector-specific behaviors and schemas
---
...
<CardGroup cols={2}>
  <Card title="Revit" href="/developers/data-model/connectors/revit" icon="cube">
    BIM authoring tool for architecture, engineering, and construction
  </Card>
  <Card title="Rhino" href="/developers/data-model/connectors/rhino" icon="cube">
    3D modeling software for design and fabrication
  </Card>
  <Card title="AutoCAD" href="/developers/data-model/connectors/autocad" icon="cube">
    2D/3D CAD software for drafting and design
  </Card>
  <Card title="Civil 3D" href="/developers/data-model/connectors/civil3d" icon="cube">
    Civil engineering design and documentation software
  </Card>
  <Card title="Navisworks" href="/developers/data-model/connectors/navisworks" icon="cube">
    Project review software for coordination and clash detection
  </Card>
  <Card title="ArchiCAD" href="/developers/data-model/connectors/archicad" icon="cube">
    BIM software for architects
  </Card>
  <Card title="Tekla" href="/developers/data-model/connectors/tekla" icon="cube">
    BIM software for structural engineering
  </Card>
  <Card title="ETABS" href="/developers/data-model/connectors/etabs" icon="cube">
    Structural analysis and design software
  </Card>
  <Card title="IFC" href="/developers/data-model/connectors/ifc" icon="cube">
...
1. **Start with core concepts** - Understand [Models](/developers/data-model/concepts), [Objects](/developers/data-model/object-model), [Proxies](/developers/data-model/proxy-model) first
2. **Review connector pages** - Understand connector-specific behaviors
3. **Use traversal recipes** - Apply [traversal patterns](/developers/data-model/traversal-recipes) to your use case
4. **Check examples** - See [working examples](/developers/data-model/examples) for common scenarios
