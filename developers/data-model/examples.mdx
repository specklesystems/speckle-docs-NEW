...
- Review [Traversal Recipes](/developers/data-model/traversal-recipes) for more patterns
- Check [Connector pages](/developers/data-model/connector-index) for connector-specific examples
- See [Object Model](/developers/data-model/object-model) for schema details
