...
<Tip>
  **Quick start:** Download the [notebook](#notebook) and run it cell by cell, or skim
  [Find your IDs](#find-your-ids) then [Step 4](#step-4-build-a-kpi-dataframe). Steps
  1–3 show the GraphQL operations the notebook calls.
</Tip>
