...
description: Learn how to view and interpret automation results in Speckle Automate. Discover how to access results from the model scene view and project dashboard, understand status messages, view artifacts, and interact with result reports.
---
...
<Frame>
  <img
    src="/images/developers/automate/scene-viewer-results.png"
    alt="Automate results in model scene viewer"
  />
</Frame>
...
<Frame>
  <img
    src="/images/developers/automate/all-runs-passed.png"
    alt="automation list showing all runs passed"
  />
</Frame>
