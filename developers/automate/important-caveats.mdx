...
description: Important caveats and limitations for Speckle Automate including beta phase data handling, access policies, infrastructure constraints, and ethical use requirements.
---
