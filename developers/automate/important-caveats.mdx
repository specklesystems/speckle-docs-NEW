...
description: Important caveats and limitations for Speckle Automate including data handling, access policies, infrastructure constraints, and ethical use requirements.
---
