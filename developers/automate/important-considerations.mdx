...
description: Important considerations and limitations for Speckle Automate including data handling, access policies, infrastructure constraints, ethical use policies, and privacy commitments.
---
...
- We strongly encourage users to back up their functions in GitHub or other repositories as a safeguard.

### Your Access

While we have designed Automate to be highly open and permissive regarding what is possible to build, there are strict usage policies:
...
Speckle Automate encourages open experimentation:
...
Automate is designed to run code within containers that execute on Linux machines:
