...
Promising use cases may qualify for [#BuildWithSpeckle collaboration](https://speckle.systems/buildwithspeckle/). Learn more or apply via the [BuildWithSpeckle page](https://speckle.systems/buildwithspeckle/) or by posting in our [Community Forum](https://speckle.community/c/automate).
</Accordion>
