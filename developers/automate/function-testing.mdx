...
description: Guide to testing Speckle Automate functions using test automations. Learn how to create sandbox environments, configure local testing with environment variables, run test cases, and validate function results against real project data.
---
...
3. Select **Create Test Automation** in the bottom left.
   ...
   <Frame>
     <img
       src="/images/developers/automate/create-test-automation.png"
       alt="create-test-automation"
     />
   </Frame>
...
<Note>
  **Future Restrictions**: We may introduce further restrictions, such as requiring the test
  automation owner to be the author of the function being tested.
</Note>
