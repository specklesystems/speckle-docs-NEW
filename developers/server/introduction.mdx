...
have deliberately chosen to operate Speckle infrastructure themselves, whether because they have a
specific requirement that Speckle Cloud cannot satisfy or because self-hosting is itself their goal.
Start with [Choosing a Speckle Deployment](/developers/server/self-hosted-vs-cloud-hosted-speckle)
if you have not yet made that decision.
