...
1. **Deployment**: Deployed Speckle Enterprise Server on Kubernetes. See our instructions for [deploying on Kubernetes](/developers/server/deployment/kubernetes-with-helm) and configuring [Speckle Enterprise Server](/developers/server/deployment/enterprise-license) for more details.
...
We _strongly_ recommend restricting the egress to the local Kubernetes cluster Pod and Service CIDR ranges.
