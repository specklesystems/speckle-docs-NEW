...
1. Update the Helm values.yaml file to reference your forked repositories:
    ...
    automate:
      github:
        templates:
          - language: Python
            ## @param automate.github.templates[0].title - The display name of the Python GitHub repository template.
            title: Python
            ## @param automate.github.templates[0].url - The URL of the GitHub repository template. This should point to a repository which can be cloned as a template repository on GitHub. It should be in the same GitHub organisation as the GitHub oAuth application. It should contain an example Speckle Function which can be used as a starting point for users creating new Automate Functions.
            url: 'https://github.com/<Your GitHub organisation>/speckle_automate_python_example'
            ## @param automate.github.templates[0].logo - The logo for the GitHub repository template. This will be displayed in the UI when users are selecting a template for their Automate Function. This can be an asset path, an absolute URL, or a base64-encoded data URI.
            ...
            ## @param automate.github.templates[1].language - The programming language of the GitHub repository template. It must be unique.
          - language: DotNet
            ## @param automate.github.templates[1].title - The display name of the .NET / C# GitHub repository template.
            title: '.NET / C#'
            ## @param automate.github.templates[1].url - The URL of the GitHub repository template. This should point to a repository which can be cloned as a template repository on GitHub. It should be in the same GitHub organisation as the GitHub oAuth application. It should contain an example Speckle Function which can be used as a starting point for users creating new Automate Functions.
            url: 'https://github.com/<Your GitHub organisation>/SpeckleAutomateDotnetExample'
            ## @param automate.github.templates[1].logo - The logo for the GitHub repository template. This will be displayed in the UI when users are selecting a template for their Automate Function. This can be an asset path, an absolute URL, or a base64-encoded data URI.
