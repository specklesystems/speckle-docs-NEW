...
description: This guide provides the minimal steps to get a Speckle server running quickly. For a complete deployment guide with all configuration options, see [Docker Compose Quickstart](/developers/server/getting-started).
---
...
2. **Configure your server** - see [Docker
  Compose Quickstart](/developers/server/getting-started) for detailed configuration options
3. **Set up SSL certificates** for production use
4. **Configure backups** and monitoring

## Getting Help

- **Full Deployment Guide**: [Docker Compose Quickstart](/developers/server/getting-started)
