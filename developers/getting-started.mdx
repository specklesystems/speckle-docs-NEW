...
sidebarTitle: Your Learning Path
description: Your learning path to building with Speckle
---

## Choose your path

Pick the documentation track that matches what you are building:
...
<CardGroup cols={2}>
  ...
  <Card title="Applications" icon="globe" href="/developers/building-apps">
...
<Steps>
  <Step title="Understand the Data Model">
    Start with the [Data Schema overview](/developers/data-schema/overview) to understand how
    Speckle structures data
  </Step>
  ...
  <Step title="Learn the API">
    Explore the [GraphQL API](/developers/api/graphql) to understand how to interact with Speckle
    Server
  </Step>
  <Step title="Choose Your Tool">Pick the right tool for your use case (see options below)</Step>
...
<CardGroup cols={2}>
  <Card title="Web applications" icon="globe" href="/developers/building-apps">
    Custom web apps and embedded viewer—see Custom apps and the Viewer tab.
  </Card>
  <Card title="Data Pipelines & ETL" icon="workflow">
    Use the Python SDK to extract, transform, and load data between applications. Build custom data
    processing workflows.
  </Card>
  <Card title="Automated Analysis" icon="robot">
    Create Automate functions that run structural analysis, code compliance checks, or generate
  ...
  <Card title="Robotics & 3D Printing" icon="printer">
    Stream geometry data directly to manufacturing systems, 3D printers, or robotic fabrication
    tools.
  </Card>
