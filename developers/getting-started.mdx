...
<CardGroup cols={2}>
  <Card title="Connectivity" icon="plug" href="/developers/developing-connectivity">
...
- [Connectivity](/developers/developing-connectivity) - Connectors and integration pathways
