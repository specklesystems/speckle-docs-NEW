...
<Note>
  [Speckle Automate](/developers/automate/introduction) runs functions **on Speckle model data**
  (checks, reports). Use Automate for on-platform processing; use specklepy + GraphQL when syncing
