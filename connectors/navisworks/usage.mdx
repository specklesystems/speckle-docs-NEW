...
description: "How to use the Navisworks connector and answers to frequently asked questions"
---
...
<Accordion title="Can I load Speckle models into Navisworks?">
  ...
  If you would like to be able to load a model into Navisworks, please reach out 
  on our Community Forum: https://speckle.community/c/features

  Include the following information:

  - Which application your Speckle model is published from
  - Why you want to load your model into Navisworks
...
<ConnectorTroubleshooting app="Navisworks" />
