---
title: How to use Speckle for Blender (beta)
sidebarTitle: Blender (beta)
description: "Step-by-step guide for using the Blender (beta) connector"
---
...
<Tip> Blender is currently in **beta**. There may be bugs while the connector is still in development.</Tip>
