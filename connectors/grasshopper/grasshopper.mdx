...
<Note>
  Grasshopper connector updates for 2026.9 run from **1 September 2026** through **1 November
  2026**. For node names, Explore, and what Load returns, see [Grasshopper in
  2026.9](/next/connectors/grasshopper/introduction).
</Note>
