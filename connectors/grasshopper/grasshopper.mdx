...
<AccordionGroup>
    ...
    <Accordion title="Can I create specific objects for other applications like Revit or ETABs?">
      Wrap your geometry in a **Speckle Object** and set the properties there. If you assign a **builtInCategory** property, it will be loaded as a generic model with that category in Revit.
