...
<AccordionGroup>
    ...
    <Accordion title="Can I create specific objects for other applications like Revit or ETABs?">
      Add your geometry to a **Collection** with the properties you want on it. If you assign a **builtInCategory** property, it will be loaded as a generic model with that category in Revit.
