...
If your team has a standard for model or layer organization, you can create a reusable node [link to best practices] with your Create Collection nodes that define sub-Collection structure for your project model.
