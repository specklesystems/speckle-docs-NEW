...
If you frequently access the same sub-Collections across multiple models, you can create a [reusable node](/grasshopper/grasshopper-recommendations#create-reusable-project-components-with-grasshopper-user-objects) with your Collection Selector and Query Objects nodes to retrieve specific objects.
