...
All Speckle Models are organized by Collections, which can contain [Speckle Objects](/grasshopper/grasshopper-objects) or other Collections. 
...
If your team has a standard for model or layer organization, you can create a [reusable node](/grasshopper/grasshopper-best-practices#create-reusable-project-components-with-grasshopper-user-objects) with your Create Collection nodes that define sub-Collection structure for your project model.
...
If you frequently access the same sub-Collections across multiple models, you can create a [reusable node](/grasshopper/grasshopper-best-practices#create-reusable-project-components-with-grasshopper-user-objects) with your Collection Selector and Query Objects nodes to retrieve specific objects.
