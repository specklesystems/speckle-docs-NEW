...
<Info>
Create Collection nodes work well for canvas-driven hierarchy. To group many elements by **computed** fields (quadrant, utilization band, nearest grid line), build collections in a C# Script — see [Enrich Speckle data in Grasshopper](/developers/sdks/dotnet/guides/use-speckle-sdk-in-grasshopper-csharp).
</Info>
