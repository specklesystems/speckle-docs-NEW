...
If your team has a standard for model or layer organization, you can create a [reusable node](../connectors/grasshopper/grasshopper-best-practices) with your Create Collection nodes that define sub-Collection structure for your project model.
...
If you frequently access the same sub-Collections across multiple models, you can create a [reusable node](../connectors/grasshopper/grasshopper-best-practices) with your Collection Selector and Query Objects nodes to retrieve specific objects.
