...
If your team has a standard for model or layer organization, you can create a [reusable node](../grasshopper-best-practices#create-reusable-project-components-with-grasshopper-user-objects) with your Create Collection nodes that define sub-Collection structure for your project model.
