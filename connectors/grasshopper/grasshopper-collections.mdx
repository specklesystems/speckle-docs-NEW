...
All Speckle Models are organized by Collections, which can contain [Speckle Objects](/grasshopper-objects) or other Collections. 
...
If your team has a standard for model or layer organization, you can create a [reusable node](/grasshopper-best-practices) with your Create Collection nodes that define sub-Collection structure for your project model.
