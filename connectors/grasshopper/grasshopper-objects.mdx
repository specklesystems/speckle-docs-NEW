...
<Warning>
  The **Speckle Data Object** node is deprecated and no longer appears in the ribbon. You do not
  need it to publish grouped geometry with properties: add [Speckle
  Geometry](/connectors/grasshopper/grasshopper-objects#geometry) straight to a
  [Collection](/connectors/grasshopper/grasshopper-collections) instead, with the properties you
  want on it.
</Warning>

Data Objects you load from other applications are unaffected. You can inspect them, read their properties, bake them, and publish them onward as normal.

### Inspecting or Modifying Speckle Data Objects

Any Speckle Data Object node already on a canvas keeps working. Since Speckle Data Objects can contain multiple geometries, use it to inspect or change their attributes.
