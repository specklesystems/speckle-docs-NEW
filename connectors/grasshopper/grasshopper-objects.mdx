...
<Info>
Passthrough nodes set **static** attributes on geometry. When you need **per-element computed metadata** or large nested graphs built from rules, use [Enrich Speckle data in Grasshopper](/developers/sdks/dotnet/guides/use-speckle-sdk-in-grasshopper-csharp) (Speckle.Sdk in a C# Script).
</Info>
