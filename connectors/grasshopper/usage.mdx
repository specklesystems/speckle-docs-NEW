...
description: "How to use the Grasshopper connector and answers to frequently asked questions"
---
...
<AccordionGroup>
    ...
    Make sure your version of Grasshopper is one of the supported versions. Installation issues are also sometimes caused by conflicting plugins. Please report your problem in our Community Forum: https://speckle.community/c/help
    ...
    <Accordion title="I used the** `Speckle` **command to open the connector in Rhino but got an error.">
