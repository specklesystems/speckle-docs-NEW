...
When viewing your model in Speckle's web app, you can switch to [**Dev Mode**](../3d-viewer/exploration) to thoroughly inspect all attributes on your Speckle objects. Some examples of exposed fields in dev mode are:
