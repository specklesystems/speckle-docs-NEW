...
The particular grouping of Properties depend on the source application - for example, Speckle Revit model objects contain properties like parameters and material quantities. 
