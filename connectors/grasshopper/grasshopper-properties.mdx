...
If your team has a standard for property sets on objects, you can create a [reusable node](../connectors/grasshopper/grasshopper-best-practices) with your Create Properties nodes that define a specific property set for your project model.
...
<Tip>
If you frequently access the same property keys across multiple objects or models, you can create a [reusable node](../connectors/grasshopper/grasshopper-best-practices) with your Property Selector and Query Properties nodes to retrieve specific properties.
</Tip>
