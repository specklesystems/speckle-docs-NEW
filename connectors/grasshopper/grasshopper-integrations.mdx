...
3D trusses, beams, and shells using Grasshopper. Currently Karamba has developed a 
v2 Speckle node that wraps the Karamba3D API, allowing you to publish and receive 
structural analysis models visualizing the real world appearance of the elements 
being analyzed.
...
and the external viewing of the models as they publish from Grasshopper, you can then 
