...
<AccordionGroup>
  ...
  <Accordion title="What if my sync fails?">
    ...
    - The integration email from [Enabling the integration on ProjectWise](#enabling-the-integration-on-projectwise) has been added as a member of the relevant ProjectWise project
