...
<Note>
In ACC sync, coordination system and reference point controls apply **only** to **Revit** (`.rvt`) files. They do not apply when syncing IFC or Navisworks files from Forma Data Management.
</Note>
