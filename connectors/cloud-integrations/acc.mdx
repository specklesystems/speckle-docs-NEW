...
<Steps>
  ...
  <Step title="Sync your first model">
    ...
    3. _Optionally_, define the view to export and set a reference point for coordinated placement. See [View Selection](#view-selection) below for details on how this affects what gets synced.
      <Frame>
