...
<Info>
  **Mac with Apple Silicon**: SketchUp requires Rosetta to run on Apple Silicon Macs. [Install Rosetta](https://support.apple.com/en-us/HT211861) before proceeding if you haven't already.
</Info>
