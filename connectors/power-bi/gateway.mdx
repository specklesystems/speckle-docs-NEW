...
- [On-premises data gateway (personal mode)](https://learn.microsoft.com/en-us/power-bi/connect-data/service-gateway-personal-mode) (external)
- [On-premises data gateway (standard mode)](https://learn.microsoft.com/en-us/power-bi/connect-data/service-gateway-onprem-indepth) (external)
- [Configure scheduled refresh](https://learn.microsoft.com/en-us/power-bi/connect-data/refresh-scheduled-refresh) (external)
