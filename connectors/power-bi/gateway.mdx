...
<Note>
  Microsoft recommends using Standard Mode for most organizational scenarios due to its enhanced
...
<Note>
  Learn more about data gateways and scheduled refresh from Microsoft: - [On-premises data gateway
  (personal
  mode)](https://learn.microsoft.com/en-us/power-bi/connect-data/service-gateway-personal-mode) -
  [On-premises data gateway (standard
  mode)](https://learn.microsoft.com/en-us/power-bi/connect-data/service-gateway-onprem-indepth) -
  [Configure scheduled
  refresh](https://learn.microsoft.com/en-us/power-bi/connect-data/refresh-scheduled-refresh)
</Note>
