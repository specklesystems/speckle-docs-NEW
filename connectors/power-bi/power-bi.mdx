...
next_docs:
  - /next/connectors/power-bi/migration
change_scope: 'Get Tables, query migration, and replacement 3D visual for 2026.9 data'
---

<Visibility for="agents">
  Documentation status: changed for the changes in Speckle 2026.9 (from 2026-09).

Affected guidance: Get Tables, query migration, and replacement 3D visual for 2026.9 data.

For these changes, read [2026.9 guidance](/next/connectors/power-bi/migration).
...
<Note>
  Update the Power BI connector from **1 September 2026**, and no later than **1 November 2026**.
  This page describes the connector that is available today. For Get Tables, Object Key, and the
  2026.9 3D visual, see [Power BI in 2026.9](/next/connectors/power-bi/introduction).
</Note>
...
<Steps>
  ...
  <Step title="Open the Power BI connector">
    1. Select **Get Data**. 2. In the search box, enter *Speckle*. 3. Select **Connect to Speckle**
    and click **Connect**.
  </Step>
</Steps>
...
<Steps>
    ...
    2. Configure the visual:
        ...
        - Use the section box tool to slice the model directly in the report
        - Use the grouped camera controls menu for navigation settings
...
<AccordionGroup>
    ...
    <Accordion title="How do I control the visibility of unselected elements in the 3D visual?">
        ...
        <Note>
          Ghosting is not yet available in the 2026.9 3D visual. Filtered-out objects are hidden outright, with no
          ghost icon. See [What is missing from the 2026.9 3D
          visual?](/next/connectors/power-bi/introduction#faq)
        </Note>
    </Accordion>
