...
<Note>
  If your Autodesk (or other) software can export a Navisworks Cache file (`.nwc`) or a Navisworks Document file (`.nwd`), you can upload it to Speckle without owning a Navisworks license.
</Note>
