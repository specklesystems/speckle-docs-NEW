...
<Note>
  Navisworks online parsing works up to the **2 GB** upload limit. ACC sync of NWC and NWD files has
  been tested to **6 GB**. A publish around **200 MB** is still advised from the 2026.8 desktop
