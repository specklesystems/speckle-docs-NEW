...
<AccordionGroup>
  ...
  <Accordion title="What types of AutoCAD entities can I publish to Speckle?">
    ...
    - Color
    - Render material
    - Extended Data and Extension Dictionaries
  </Accordion>
  ...
  <Accordion title="Why is my new model name pre-filled?">
    New model creation defaults to your current file name, so you do not need to manually remove full path-like names
    before publishing. You can still rename the model before sending.
  </Accordion>
