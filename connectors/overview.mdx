...
In [How Speckle Works](/quickstart/welcome#how-speckle-works) we covered the basics of how data flows in Speckle. We'll now see these two core mechanisms more in detail.
...
Every time a file is uploaded a new version of the Speckle model is created, 
this allows to keep the version history of each file. New versions can be uploaded 
by using the drop down menu on each model.