...
<AccordionGroup>
    <Accordion title="How to set up Speckle connector for On-premises data gateway (personal mode)?">
        ...
        4. Select **Sign In** and sign in to your account.
            <Frame>
                <img src="/images/connectors/powerbi/personal dg sign in.png" alt="Grasshopper toolbar" />
            </Frame>
            <Note>
        ...
        5. Select the **Connectors** tab and verify Speckle appears in the connectors list.
            <Frame>
                <img src="/images/connectors/powerbi/personal dg connectors.png" alt="Grasshopper toolbar" />
            </Frame>
            <Note>
        ...
        2. Select **More Options (…) > View semantic model** from the top bar.
            <Frame>
                <img src="/images/connectors/powerbi/dg view semantic model.png" alt="Grasshopper toolbar" />
            </Frame>

        3. Select **Refresh > Schedule Refresh**. This opens settings for the semantic model.
            
            <Frame>
                <img src="/images/connectors/powerbi/dg schedule refresh.png" alt="Grasshopper toolbar" />
            </Frame>
            
        4. Expand **Gateway and cloud connections** and check if your personal gateway is listed here.
            
            <Frame>
                <img src="/images/connectors/powerbi/personal dg gateways list.png" alt="Grasshopper toolbar" />
            </Frame>
            
        5. After you confirm the personal gateway is listed, select **Data source credentials**, then select **Speckle** > **Edit credentials**.
            
            <Frame>
                <img src="/images/connectors/powerbi/personal dg edit credentials.png" alt="Grasshopper toolbar" />
            </Frame>
            
        6. Select **OAuth2** as your authentication method. Set the privacy level setting according to your needs.
            
            <Frame>
                <img src="/images/connectors/powerbi/personal dg oauth.png" alt="Grasshopper toolbar" />
            </Frame>
    ...
    <Accordion title="How to set up Speckle connector for On-premises data gateway (standard mode)?">

        #### Install data gateway and Power BI connector

        1. Download and install [On-premises data gateway](https://go.microsoft.com/fwlink/?LinkId=820925&clcid=0x409).
        2. Open the data gateway.
        3. Select **Sign In** and sign in to your account.
            
            <Frame>
                <img src="/images/connectors/powerbi/on prem sign in.png" alt="Grasshopper toolbar" />
            </Frame>
        ...
        4. Select the **Connectors** tab and copy the path to Custom Connectors folder
            ...
            <Frame>
                <img src="/images/connectors/powerbi/on prem copy path.png" alt="Grasshopper toolbar" />
            </Frame>
        ...
        8. Verify Speckle appears under Custom Connectors tab.
            ...
            <Frame>
                <img src="/images/connectors/powerbi/on prem connectors.png" alt="Grasshopper toolbar" />
            </Frame>
        ...
        3. Select **Refresh > Schedule Refresh** to opens settings for the semantic model.
        ...
        4. Expand **Gateway and cloud connections** and check if your gateway is listed.
            ...
            <Frame>
                <img src="/images/connectors/powerbi/on prem gateway listed.png" alt="Grasshopper toolbar" />
            </Frame>
            
        5. If you see “Not configured correctly” under status, select **View data sources (▶️)**.
            
            <Frame>
                <img src="/images/connectors/powerbi/on prem view data source.png" alt="Grasshopper toolbar" />
            </Frame>
            
        6. Select **Manually add to gateway** for the Speckle model you’ve loaded.
            
            <Frame>
                <img src="/images/connectors/powerbi/on prem manually add.png" alt="Grasshopper toolbar" />
            </Frame>
            
        7. Create a new connection.
            
            <Frame>
                <img src="/images/connectors/powerbi/on prem create connection.png" alt="Grasshopper toolbar" />
            </Frame>
        ...
        9. Select the newly created collection name from the **Maps to** dropdown and select **Apply**.
            ...
            <Frame>
                <img src="/images/connectors/powerbi/on prem maps to.png" alt="Grasshopper toolbar" />
            </Frame>
            

        Your data gateway is now configured for scheduled refresh.

        ## Learn more

        - [On-premises data gateway](https://learn.microsoft.com/en-us/power-bi/connect-data/service-gateway-onprem-indepth)
        - [Configure scheduled refresh](https://learn.microsoft.com/en-us/power-bi/connect-data/refresh-scheduled-refresh)
    </Accordion>

    <Accordion title="Error message: 'Query contains unknown function name: Speckle.GetByUrl'">
        <Frame>
            <img src="/images/connectors/powerbi/dg unknown function.png" alt="Grasshopper toolbar" />
        </Frame>
        ...
        **To troubleshoot this error:**
        ...
        1. Verify the gateway appears in Power BI service under **Settings** > **Manage connections and gateways** > **On-premises data gateways**.
            ...
            <Frame>
                <img src="/images/connectors/powerbi/dg verify gateway.png" alt="Grasshopper toolbar" />
            </Frame>
