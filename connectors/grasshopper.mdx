---
title: How to use Speckle for Grasshopper (beta)
sidebarTitle: Grasshopper (beta)
description: "Step-by-step guide for using the Grasshopper (beta) connector"
---
...
<Steps>
    ...
    <Step title="Connect your Speckle account">
      ...
      2. Add the **Accounts** node to the canvas, and click **Sign in**.
