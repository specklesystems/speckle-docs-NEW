...
- **batchObjects**: The group of [_BatchObject_](/dev/viewer/batch-object-api)s that will make up this top level acceleration structure
...
The top-level [_AccelerationStructure_](/dev/viewer/acceleration-structure-api) built on top of the group of bottom-level BVHs.
<Warning>
...
**Returns**: [_ExtendedIntersection_](/dev/viewer/top-level-acceleration-structure-api#extendedintersection)
...
<Tip>
`refit` is called automatically whenever any of the comprising [_BatchObjects_](/dev/viewer/batch-object-api) update their transformation.
</Tip>
...
- **callbacks**: [ExtendedShapeCastCallbacks](/dev/viewer/top-level-acceleration-structure-api#extendedshapecastcallbacks)
