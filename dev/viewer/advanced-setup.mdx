...
The viewer can be extended with functionality via [extensions](/dev/viewer/overview#extensions). The package already contains a few stock extensions that offer typical functionality.
