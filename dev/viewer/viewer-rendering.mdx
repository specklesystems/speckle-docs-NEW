...
The nodes from the previously defined [WorldTree](/dev/viewer/viewer-data/#worldtree)
...
<Frame>
  <img src="/images/dev/viewer/rendertree2.png" />
</Frame>
...
<Frame>
  <img src="/images/dev/viewer/rendertree.png" />
</Frame>
...
- Objects need to be of the same [_GeometryType_](/dev/viewer/render-view-api#geometrytype-enum).
...
objects individually in any way. This is achieved using [_BatchObject_](/dev/viewer/batch-object-api)s.
