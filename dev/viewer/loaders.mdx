...
The up-to-date types the viewer works with can be found [here](/dev/viewer/geometry-converter-api#speckletype), however internally the viewer doesn't rely that much on these types, and they are mostly relevant at conversion time.
