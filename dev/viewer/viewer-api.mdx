...
- **hits**: The array of hits sorted by distance, where closest is first. _node_ is the intersected [_TreeNode_](/dev/viewer/world-tree-api#treenode) and _point_ is it's point of intersection.
...
- **radius**: Sun distance from [_World_](/dev/viewer/viewer-api#worldclass) center.
