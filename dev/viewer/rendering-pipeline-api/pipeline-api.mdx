...
- **speckleRenderer**: The hosting renderer as [SpeckleRenderer](/viewer/speckle-renderer-api.md)
...
The pipeline's ordered [GPass](/viewer/rendering-pipeline-api/g-pass-api.md).

**Returns**: `Array<`[`GPass`](/viewer/rendering-pipeline-api/g-pass-api.md)`>`
...
**Returns**: [SpeckleRenderer](/viewer/speckle-renderer-api.md)
...
**Returns**: [`GPass[]`](/viewer/rendering-pipeline-api/g-pass-api.md)
