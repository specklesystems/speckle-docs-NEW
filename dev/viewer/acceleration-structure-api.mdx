...
- **options**: [_BVHOptions_](/dev/viewer/acceleration-structure-api#bvhoptions)
...
<Warning>
  ...
  [getBoundingBox](/dev/viewer/acceleration-structure-api#getboundingbox),
  [getVertexAtIndex](/dev/viewer/acceleration-structure-api#getvertexatindex),
  [raycast](/dev/viewer/acceleration-structure-api#raycast),
  [raycastFirst](/dev/viewer/acceleration-structure-api#raycastfirst),
  [shapecast](/dev/viewer/acceleration-structure-api#shapecast) already call
