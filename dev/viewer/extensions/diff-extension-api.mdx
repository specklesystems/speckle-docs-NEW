...
- **mode**: The [_VisualDiffMode_](/dev/viewer/extensions/diff-extension-api#visualdiffmode)
- _optional_ **authToken** Used for potentially loading models

**Returns**: `Promise <`[`_DiffResult_`](/dev/viewer/extensions/diff-extension-api#diffresult)`>`
...
- _optional_ **model**: [_VisualDiffMode_](/dev/viewer/extensions/diff-extension-api#visualdiffmode)
