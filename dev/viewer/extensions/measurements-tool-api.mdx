...
**Returns**: [_Measurement_](/dev/viewer/extensions/measurements-tool-api#measurement)
...
**Returns**: [_MeasurementOptions_](/dev/viewer/extensions/measurements-tool-api#measurementoptions)
