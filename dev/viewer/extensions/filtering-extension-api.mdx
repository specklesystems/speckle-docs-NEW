...
Returns the current [_FilteringState_](/dev/viewer/extensions/filtering-extension-api#filteringstate-2).

**Returns**: [_FilteringState_](/dev/viewer/extensions/filtering-extension-api#filteringstate-2)
...
- **prop**: [_PropertyInfo_](/dev/viewer/extensions/filtering-extension-api#propertyinfo)
- _optional_ **ghost**" Whether to ghost the rest of the objects
