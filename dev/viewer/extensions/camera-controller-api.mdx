...
Gets the current underlying [_SpeckleControls_](/dev/viewer/extensions/speckle-controls-api) implementation.

**Returns**: [_SpeckleControls_](/dev/viewer/extensions/speckle-controls-api)
...
**Returns**: [CameraControllerOptions](/dev/viewer/extensions/camera-controller-api#cameracontrolleroptions)
...
- **eventType**: [_CameraEvent_](/dev/viewer/extensions/camera-controller-api#cameraevent)
- **listener**: The handler for the events with [_CameraEventPayload_](/dev/viewer/extensions/camera-controller-api#cameraeventpayload) arguments
...
- **e**: [_CameraEvent_](/dev/viewer/extensions/camera-controller-api#cameraevent)
...
- **view**: Explicit view of different possible type: [_CanonicalView_](/dev/viewer/extensions/camera-controller-api#canonicalview), [_SpeckleView_](/dev/viewer/extensions/camera-controller-api#speckleview), [_InlineView_](/dev/viewer/extensions/camera-controller-api#inlineview)
- **transition**: Whether or not to make the transition animated
- _optional_ **fit**: Linear tolerance
