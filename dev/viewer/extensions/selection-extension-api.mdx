...
**Returns**: [_SelectionExtensionOptions_](/dev/viewer/extensions/selection-extension-api#selectionextensionoptions)
...
<Tip>
  ...
  [_RenderMaterial_](/dev/viewer/extensions/speckle-material-api#rendermaterial),
  a [_DisplayStyle_](/dev/viewer/extensions/speckle-material-api#displaystyle)
  and a
  [_MaterialOptions_](/dev/viewer/extensions/speckle-material-api#materialoptions)
