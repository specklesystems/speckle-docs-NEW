...
<Tip>
  ...
  [_RenderMaterial_](/dev/viewer/speckle-material-api#rendermaterial),
  a [_DisplayStyle_](/dev/viewer/speckle-material-api#displaystyle)
  and a
  [_MaterialOptions_](/dev/viewer/speckle-material-api#materialoptions)
