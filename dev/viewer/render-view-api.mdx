...
- **data**: [_NodeRenderData_](/dev/viewer/render-view-api#noderenderdata)
...
Gets this render view's [_GeometryType_](/dev/viewer/render-view-api#geometrytypeenum).
...
Gets the render view's associated [_NodeRenderData_](/dev/viewer/render-view-api#noderenderdata).

**Returns**: [_NodeRenderData_](/dev/viewer/render-view-api#noderenderdata)
...
Gets the render view's render data [_SpeckleType_](/dev/viewer/geometry-converter-api#speckletype).
...
<Warning>
The render view's aabb can be read by using [_aabb_](/dev/viewer/render-view-api#aabb), but do note that it does not take user transformations nor instance transformations into account.
</Warning>
...
This is the bare bones data representation of anything renderable in the viewer. The [_NodeRenderView_](/dev/viewer/render-view-api#constructor) is more or less a wrapper around this data that adds some shorthands and

- **id**: The id of the object. For speckle data, this would be the speckle id
- **subtreeId**: The id of the subtree of the host node
- **speckleType**: [_SpeckleType_](/dev/viewer/geometry-converter-api#speckletype)
- **geometry**: Raw geometry information stored as [_GeometryData_](/dev/viewer/render-view-api#geometrydata)
- **renderMaterial**: Raw material information stored as [_RenderMaterial_](/dev/viewer/speckle-material-api#rendermaterial)
- **DisplayStyle**: Raw line material information stored as [_DisplayStyle_](/dev/viewer/speckle-material-api#displaystyle)
...
- **attributes**: [_GeometryAttributes_](/dev/viewer/render-view-api#geometryattributes) Vertex attribute arrays
