...
The batch's [_GeometryType_](/dev/viewer/render-view-api#geometrytypeenum).

**Returns**: [_GeometryType_](/dev/viewer/render-view-api#geometrytypeenum)
...
**Returns**: [_DrawGroup[]_](/dev/viewer/batch-api#drawgroup)
...
- Initialising the batch's [_renderObject_](/dev/viewer/batch-api#renderobject)
...
Gets the batch's [_BatchUpdateRange_](/dev/viewer/batch-api#batchupdaterange) required for the depth pass.

**Returns**: [_BatchUpdateRange_](/dev/viewer/batch-api#batchupdaterange)
...
- **renderView**: [_NodeRenderView_](/dev/viewer/render-view-api)
...
Gets the batch's opaque [_BatchUpdateRange_](/dev/viewer/batch-api#batchupdaterange).
...
Gets the batch's stencil [_BatchUpdateRange_](/dev/viewer/batch-api#batchupdaterange).
...
Gets the batch's transparent [_BatchUpdateRange_](/dev/viewer/batch-api#batchupdaterange).
...
Gets the batch's visible [_BatchUpdateRange_](/dev/viewer/batch-api#batchupdaterange).

**Returns**: [_BatchUpdateRange_](/dev/viewer/batch-api#batchupd
...
Resets the batch to its default state where there is a single draw group rendered with the [_batchMaterial_](/dev/viewer/batch-api#batchmaterial).
...
Updates relevant batch buffers based on the [_MaterialOptions_](/dev/viewer/speckle-material-api#materialoptions) from the provided [_BatchUpdateRange_](/dev/viewer/batch-api#batchupdaterange). Implementation specific.

**Parameters**

- **range**: [_BatchUpdateRange_](/dev/viewer/batch-api#batchupdaterange)
...
<Tip>
  ...
  SpeckleRenderer's
  [_setMaterial_](/dev/viewer/speckle-renderer-api#setmaterial) which calls this
  method internally.
</Tip>

**Parameters**

- **ranges**: [_BatchUpdateRange_](/dev/viewer/batch-api#batchupdaterange)
...
<Tip>
  The viewer's [_MeshBatch_](/dev/viewer/batch-api#meshbatch) implementation of
