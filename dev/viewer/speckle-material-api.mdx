...
- **filterType**: [_FilterMaterialType_](/dev/viewer/speckle-material-api#filtermaterialtype)
...
- _optional_ **stencilOutlines**: [_StencilOutlineType_](/dev/viewer/speckle-material-api#stenciloutlinetype). Only applies to meshes
