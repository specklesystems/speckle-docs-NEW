...
The viewer stores data in a hierarchical fashion inside a tree-like structure which we call [_WorldTree_](/dev/viewer/world-tree-api#worldtree)

<Frame>
  <img src="/images/dev/viewer/worldtree.png" />
</Frame>
...
<Tip>
  ...
  [*findAll*](/dev/viewer/world-tree-api#findall),
  [*walk*](/dev/viewer/world-tree-api#walk) and
  [*walkAsync*](/dev/viewer/world-tree-api#walkasync) since it can easily amount
