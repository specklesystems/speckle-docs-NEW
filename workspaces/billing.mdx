...
<Note>
  Workspaces come in three plans: **Free**, **Starter**, and **Business**. View pricing and find the plan that matches your needs on [speckle.systems/pricing](https://www.speckle.systems/pricing). Speckle is free without limits for academia.
</Note>
...
- **Get unlimited projects and models:** You can add the _Unlimited projects and models_ add-on to your Business plan to remove those usage limits.
