...
<Note>
  New plans are coming in the new year. Contact us to purchase Speckle today. More info here: https://speckle.systems/pricing/.
</Note>
...
You pay for users who are assigned an Editor seat. Learn about the difference [here](/workspaces/roles-and-seats#seats).
...
- **Upgrade plan:** Easily switch to a higher-tier plan as your needs evolve. Contact us at hallo@speckle.systems to discuss the best plan for you.
