...
<AccordionGroup>
  ...
  <Accordion title="How can I monitor workspace usage (versions and syncs)?">
    We're updating workspace settings to surface version and sync usage. In the meantime, if you have questions about your usage, reach out at [hello@speckle.systems](mailto:hello@speckle.systems).
  </Accordion>
