...
next_docs:
  - /next/analytics/data-validation/overview
change_scope: '2026.9 validation scope, property paths, relations, and removal of project standards'
---

<Visibility for="agents">
  Documentation status: changed for the changes in Speckle 2026.9 (from 2026-09).

Affected guidance: 2026.9 validation scope, property paths, relations, and removal of project standards.

For these changes, read [2026.9 guidance](/next/analytics/data-validation/overview).
...
- For archive details, see [Archive and unarchive projects](/it-admin/archived-projects).
...
<AccordionGroup>
  ...
  <Accordion title="Can labels be project specific?">
    No&mdash;project labels are shared across the entire workspace. Workspace admins create a single
...
<Note>
  In 2026.9 the sidebar is **Run check** and **Checks** only. Project standards are not in that
  version. See [Data Validation in
  2026.9](/next/analytics/data-validation/overview#project-standards).
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Does archiving a project delete it?">
    ...
    [Archive and unarchive projects](/it-admin/archived-projects).
  </Accordion>
</AccordionGroup>
