...
When deploying connectors manually, you only need to update connector addons. DUI updates automatically. <DisableUpdateNotifications /> A download link will be available in the manual installation guides in future.
</Warning>
