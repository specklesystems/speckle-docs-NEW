...
<Note>
This page is scoped to IT administrative tasks only. For end-user guides, see [Connector Installation](/connectors/installation) and [Workspace Management](/workspaces/introduction).
</Note>
