...
<Steps>
  ...
  <Step title="Enter your warehouse details">
    ...
    - **Authentication method** — **OAuth (service principal)** with your **Client ID** and **Client secret**, or **Personal access token** with your token. On Databricks **Free Edition**, service-principal OAuth can be restricted — use an access token instead.
