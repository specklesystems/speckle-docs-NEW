...
<Note>
  The Databricks integration is in **Beta** and is enabled per workspace. If you don't see
  Databricks under your project's **Integrations**, submit the [beta access request
