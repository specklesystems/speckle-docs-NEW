...
<Note>
Admin support mode requires the workspaces module. Both `FF_ADMIN_SUPPORT_MODE_ENABLED` and `FF_WORKSPACES_MODULE_ENABLED` must be set to `true` in your server environment. Restart the server after changing these values.
</Note>
