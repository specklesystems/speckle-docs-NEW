...
By default, new users are assigned the free Viewer seat when they are invited to a workspace. This means they won't be able to contribute to projects as an editor until an Admin has upgraded their seat to an Editor seat. You can learn more about seats [here](/workspaces/roles-and-seats#seats).

To automatically assign Editor seats to new people joining your workspace, change the default seat type under Workspace settings → Security.
