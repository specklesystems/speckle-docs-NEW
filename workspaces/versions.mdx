...
Versions are stored forever or until you delete a model for which they were created.

Versions help you keep track of changes, they record who published them, form which source 
updated what and when, by default everyone always sees the latest version with the flexibility
