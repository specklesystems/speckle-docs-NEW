...
Both samples start from the same PAT and ids. Paste the [scripts and notebooks](/developers/sdks/dotnet/getting-started/scripts-and-notebooks)
bootstrap once, then the only change is the receive call.
...
<Tabs>
  ...
  <Tab title="v2026.9">
    ...
    var hosted = model.Objects.Where(o => o.Host is not null).ToList();
    ```
