...
Prior to 2026.9, the path is still **PAT → bootstrap → `Receive2` → `Flatten`**. In v2026.9 that
...
| Concern                 | Prior to 2026.9                            | In v2026.9                                                                                          |
| ----------------------- | ------------------------------------------ | --------------------------------------------------------------------------------------------------- |
...
Prior to 2026.9, you resolve `referencedObject` and call `Receive2`. In v2026.9, `Receive2` is marked
...
<Tabs>
  <Tab title="Prior to 2026.9 (Receive2)">
    ```csharp Prior to 2026.9 lines icon="/images/developers/sdks/csharp.svg"
...
Prior to 2026.9, you walk a `Base` tree. In v2026.9, objects are a flat list. Properties are path-keyed
