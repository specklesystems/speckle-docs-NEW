...
In the Current [Geometry Schema](/developers/data-schema/geometry-schema), geometry is a list of
...
| 4     | faces        | i32 × face count | The same flattened face list as the Current `Mesh.faces` |
