...
live map for workspace admins. [Configuration](/workspaces/configuration) still covers
...
project's **General**, **Webhooks**, **Tokens**, and **Automations**. [Configuration](/workspaces/configuration) still describes project visibility, collaborators, and
share tokens.
...
<AccordionGroup>
  ...
  <Accordion title="How do I turn AI features off for the workspace?">
    Open **Settings**, then **General**, and turn **AI features** off. Only workspace admins can
    change it, and it applies to everyone in the workspace. See [Turn AI features off for the
    workspace](/next/it-admin/introduction#turn-ai-features-off-for-the-workspace).
  </Accordion>
  <Accordion title="Where do I manage SSO or SCIM?">
    Open **Settings**, then **Security**. The existing guides still apply: [SSO](/workspaces/sso)
    and [SCIM](/workspaces/scim).
  </Accordion>
</AccordionGroup>
