...
Open workspace **Settings** when a change should apply to the whole workspace. The children in the
sidebar are the live map. Current [Configuration](/workspaces/configuration) still covers SSO,
SCIM, billing, and roles in depth. This page does not clone those guides.
...
- **Usage** — activity, plan limits, and AI spend. Workspace admins see this item when the plan
  includes usage analytics. The 2026.9 how-to is a separate page in this preview.
...
- **Skills** — reusable instructions for Speckle Intelligence Chat. Members see this item when the
  plan includes Chat. This preview does not include a Skills how-to.
- **AI Rules** — rules that constrain Speckle Intelligence. Members can open this item. This
  preview does not include an AI Rules how-to.

<Note>
  **Skills** and **AI Rules** are pointers only on this page. Do not expect a 2026.9 how-to for
  either yet. **Usage** has its own 2026.9 page when that ticket lands.
</Note>
