...
<AccordionGroup>
  ...
  <Accordion title="Can a rule turn Speckle Intelligence off?">
    No. Rules constrain answers; they do not stop conversations. To make Chat and the viewer sparkle
    unavailable to the whole workspace, a workspace admin turns **AI features** off in **Settings**,
    then **General**. See [Turn AI features off for the
