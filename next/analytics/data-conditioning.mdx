...
description: In v2026.9 you batch-edit parameters in the Elements panel, then apply them in the connector via Issues.
noindex: true
contextual:
  options: []
---
...
In v2026.9 you review and batch-edit model parameters from the **Elements** panel
...
<Note>
  Parameter updates in v2026.9 run against models in the new data format. If a model has not moved
...
dashboard. In v2026.9 that widget is not the path: you work on the models already
open in the viewer.
...
<AccordionGroup>
  <Accordion title="Where did the Parameter Updater dashboard widget go?">
    In v2026.9 you edit from **Elements** in the model viewer, not from a Data Conditioning widget.
