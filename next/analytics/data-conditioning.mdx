...
{/* IMAGE_PLACEHOLDER: Model viewer — Elements panel in the bottom dock, table of elements for loaded models. */}
...
{/* IMAGE_PLACEHOLDER: Elements toolbar — Update parameters (pencil) on; properties columns editable; group rows; Columns New attribute name…. */}
...
{/* IMAGE_PLACEHOLDER: Elements footer — unsaved edit count, Discard, Submit change requests, Issue title fields. */}
