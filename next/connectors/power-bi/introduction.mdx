...
<Warning>
  Firefox on macOS does not support WebGPU as of 2026.9.3, so the 3D visual will not render in Power
  BI Service reports opened there. This is a known, accepted limitation, not a bug — use a
  Chromium-based browser or Power BI Desktop instead.
</Warning>
...
<AccordionGroup>
  ...
  <Accordion title="Which browsers and environments does the 3D visual support?">
    ...
    support the visual. Firefox on macOS does not — it lacks WebGPU support as of 2026.9.3, so the
    visual will not render there. This is a known, accepted limitation.
  </Accordion>
</AccordionGroup>
