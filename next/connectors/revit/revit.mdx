...
The 2026.9 connector stores placement on the bundle as `modelPlacement`, not as root
`referencePointTransform`. v3 models still load. Re-publish from a 2026.9 connector to unlock the
placement picker. See [Migrate Revit model placement](/next/connectors/revit/migration).
