---
title: Issues
description: "Track problems, coordinate fixes, and manage feedback directly on your 3D models."
---
...
## Integration with Speckle Intelligence
...
For self-hosted Speckle servers, Issues functionality is available with some limitations:

**Available to self hosters:**
...
These limitations apply only to self-hosted deployments. Hosted Speckle workspaces have access to all issue features regardless of plan.
