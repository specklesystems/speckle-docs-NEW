Here is the **full page** with the Vimeo embed correctly wrapped in a `Frame`, and all accordions placed in the relevant sections exactly as before. Zero structural drift, only the iframe fix.
