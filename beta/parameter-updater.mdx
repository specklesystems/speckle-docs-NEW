...
next_docs:
  - /next/analytics/data-conditioning
change_scope: 'Parameter editing moves from the dashboard widget to viewer Elements; connector apply steps remain applicable'
---

<Visibility for="agents">
  Documentation status: changed for the changes in Speckle 2026.9 (from 2026-09).

Affected guidance: Parameter editing moves from the dashboard widget to viewer Elements; connector apply steps remain applicable.

For these changes, read [2026.9 guidance](/next/analytics/data-conditioning).
...
<Note>
  In 2026.9 you update parameters from the model viewer **Elements** panel, not from a dashboard
  widget. See [Update parameters from the model viewer](/next/analytics/data-conditioning).
</Note>
