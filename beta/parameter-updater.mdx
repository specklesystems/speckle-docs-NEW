...
![Revit connector publishing a model alongside the Parameter Updater widget](/images/analytics/parameter-updater-connector-and-widget-side-by-side.png)
...
<Steps>
  ...
  <Step title="Configure the Parameter Updater widget">
    ...
    ![Widget configuration sidebar showing data sources, columns, and group by](/images/analytics/parameter-updater-widget-configuration-sidebar.png)
  </Step>
  <Step title="Review and edit parameters">
    ...
    ![Parameter Updater table showing editable, read-only, and missing parameter cells with the footer bar](/images/analytics/parameter-updater-editable-read-only-missing-parameter-cells.png)
  ...
  <Step title="Apply the approved changes">
    ...
    ![Connector Issue panel showing the Apply changes action and success toast](/images/analytics/parameter-updater-applying-changes.png)
  </Step>
</Steps>
