...
Using Manager to handle your accounts and [connectors](#installing-connectors) is the recommended way, but if you'd like to do without it a manual flow is also available.

To manually add an account you first need to generate a token for your account.
...
You will receive a notification in Speckle Manager when updates for your installed connectors are available. You can then update them from the [connectors](#installing-connectors) page.
...
Just head over the [connectors](#installing-connectors) page in Speckle Manager and click **Remove**.
