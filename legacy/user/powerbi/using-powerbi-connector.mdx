...
<Frame>
  <img src="/images/legacy/powerbi/4-receive-methods.png" alt="Receive Methods" />
</Frame>
...
<Frame>
  <img src="/images/legacy/powerbi/5-default-method.gif" alt="Default method demonstration" />
</Frame>

The result of that query will be a table with the following columns:

<Frame>
  <img src="/images/legacy/powerbi/6-received-data-columns.png" alt="Received Data Columns" />
</Frame>
...
<Tip>
  Model URL, Version Object ID and Object ID were added to facilitate loading data into the new
  Speckle Power BI 3D Viewer
</Tip>
...
<Frame>
  <img src="/images/legacy/powerbi/7-data-records.png" alt="Data Records" />
</Frame>
...
This new function allows for much faster interactions with your Speckle data, as it no longer requires you to pull every single object as a flat list. There's a small downside to this, as you will no longer get the data with the expected columns to connect it directly to the _Speckle Power BI Visual_.
