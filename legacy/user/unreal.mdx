...
<Info>
  For additional resources, see Unreal's guides on [Installing Unreal
  Engine](https://docs.unrealengine.com/4.27/en-US/Basics/InstallingUnrealEngine/), [Setting Up
  Visual Studio for Unreal
  Engine](https://docs.unrealengine.com/4.27/en-US/ProductionPipelines/DevelopmentSetup/VisualStudioSetup/),
...
1. In the `Place Actors` sidebar, search for _Speckle Unreal Manager_ and add it to the world.

<Frame>
  <img
    src="/images/legacy/unreal/speckle_manager_actor.png"
    width="50%"
    alt="speckle manager actor"
  />
</Frame>
...
<Frame>
  <img
    src="/images/legacy/unreal/speckle_manager_config.png"
    width="50%"
    alt="speckle manager config"
  />
</Frame>
...
<Frame>
  <img
    src="/images/legacy/unreal/finding_stream_id.png"
    width="75%"
    alt="screenshot of a speckle project url https://app.speckle.systems/streams/76c45cdb32, with the project id 76c45cdb32 highlighted"
  />
</Frame>
...
<Frame>
  <img
    src="/images/legacy/unreal/finding_object_id.png"
    width="75%"
    alt="screenshot of the property panel of a Speckle version,> highlighting the object ID of the selected (root) object"
  />
</Frame>
...
<Frame>
  <img
    src="/images/legacy/unreal/generate_auth_token.png"
    width="75%"
    alt="screen shot of profile page, with arrow pointing towards the new token button"
  />
</Frame>
...
<Frame>
  <video
    ...
    autoplay
    muted
    src="/images/legacy/unreal/stream.branch.commit.selection.mp4"
    type="video/mp4"
    alt="Project, model, and version selection in Speckle Unreal Manager"
    aria-label="Project, model, and version selection in Speckle Unreal Manager"
  />
</Frame>
...
<Warning>
  Treat your Personal Access Token **as a password**. If someone else has access to your auth token,
  they can access your Speckle data!
</Warning>
...
<Frame>
  <img src="/images/legacy/unreal/receiving_bp.png" width="100%" alt="receiving bp" />
</Frame>
...
<Frame>
  <video
    ...
    autoplay
    muted
    src="/images/legacy/unreal/converter-settings.mp4"
    type="video/mp4"
    alt="StaticMeshConverter settings exposed in the Unreal editor"
    aria-label="StaticMeshConverter settings exposed in the Unreal editor"
  />
</Frame>
...
<center>
  <img src="/images/legacy/unreal/create_converter.png" width="66.66%" alt="Create converter" />
</center>

You can create your own custom converters in BP/C++ (see [Creating Custom Conversion](#developing-custom-conversion-logic) docs)
...
For some users, the simple flat shaded PBR materials converted using an object's `RenderMaterial`(https://github.com/specklesystems/speckle-sharp/blob/main/Objects/Objects/Other/RenderMaterial.cs) will be all they want.
...
Speckle's `Objects`(https://speckle.guide/developers/objects.html) kit supports PBR materials through
the `RenderMaterial`(https://github.com/specklesystems/speckle-sharp/blob/main/Objects/Objects/Other/RenderMaterial.cs) property of Speckle meshes.
...
<Frame>
  <img src="/images/legacy/unreal/SpeckleMaterial.png" width="50%" alt="speckle material" />
</Frame>
...
<Frame>
  <img
    src="/images/legacy/unreal/SpeckleGlassMaterial.png"
    width="50%"
    alt="speckle glass material"
  />
</Frame>
...
<Frame>
  <img src="/images/legacy/unreal/OverridesById.png" width="66.66%" alt="overrides by id" />
</Frame>
...
<Frame>
  <img src="/images/legacy/unreal/OverridesByName.png" width="66.66%" alt="overrides by name" />
</Frame>
...
<Frame>
  <img
    src="/images/legacy/unreal/new_blueprint.png"
    width="50%"
    alt="Screenshot of the blueprint creation menu, creating a new blueprint of type UObject"
  />
</Frame>

Under _Class Settings_ add `ISpeckleConverter` to the _Implemented Interfaces_ list.

<Frame>
  <img
    src="/images/legacy/unreal/bp_speckle_converter_interface.png"
    width="50%"
    alt="Screenshot of the blueprint details, showing adding ISpeckleConverter as an implemented interface"
  />
</Frame>
...
<Frame>
  <img
    src="/images/legacy/unreal/bp_functions.png"
    width="50%"
    alt="Screenshot of blueprint editor, showing the interface functions"
  />
</Frame>
