...
<Image src="./img-blender/enable-addon.png" alt="activating the Blender Connector" />
...
However, you will still need to add your accounts, either through [Speckle Manager](/legacy/user/manager) (recommended) or [manually](/legacy/user/manager#adding-accounts-manually)
