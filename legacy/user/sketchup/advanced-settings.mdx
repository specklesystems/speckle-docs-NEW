...
<Frame>
    <img className="rounded-dropshadow" src="/images/legacy/sketchup/advanced-settings.png" width={350} alt="Advanced Settings Dialog" />
</Frame>
...
<Warning>
The feature currently shows only the geometries modified with the push-pull tool between the versions.
</Warning>
