...
<Frame>
  <img
    ...
    src="/images/legacy/sketchup/advanced-settings.png"
    width={350}
    alt="Advanced Settings Dialog"
  />
</Frame>
...
<Warning>
  Notably, this registration process might slightly increase the conversion time, typically by
  around 10% to 40%.
</Warning>
...
<Warning>
  The feature currently shows only the geometries modified with the push-pull tool between the
  versions.
</Warning>
