...
<Frame>
  <video
    ...
    muted
    loop
    src="/images/legacy/sketchup/sending.mp4"
    type="video/mp4"
    alt="Sending"
    aria-label="Sending"
  />
...
<Frame>
  <video
    ...
    muted
    loop
    src="/images/legacy/sketchup/receiving.mp4"
    type="video/mp4"
    alt="Receiving"
...
<Warning>
  Note that if you sent SketchUp groups to a model, they will be received as component instances
  rather than groups.
</Warning>
...
<Frame>
  <video
    ...
    muted
    loop
    src="/images/legacy/sketchup/create-stream.mp4"
    type="video/mp4"
    alt="Create stream"
...
<Frame>
  <video
    ...
    muted
    loop
    src="/images/legacy/sketchup/create-branch.mp4"
    type="video/mp4"
    alt="Create branch"
...
<Frame>
  <video
    ...
    muted
    loop
    src="/images/legacy/sketchup/add-by-id.mp4"
    type="video/mp4"
    alt="Add by id"
...
<Frame>
  <video
    ...
    muted
    loop
    src="/images/legacy/sketchup/switching-accounts.mp4"
    type="video/mp4"
    alt="Switching accounts"
