...
<Tip>
Unsure what *commits* and *branches* are? 🤔
...
<img
  src="/images/legacy/gh/image-20210322180706379.png"
  alt="Creating a new Send node in Grasshopper"
/>
...
<img
  src="/images/legacy/gh/image-20210322183400126.png"
  alt="Auto receive toggle in Receive node context menu"
/>
...
<Note>
  When receiving from a commit, the node will stop showing notifications about new activity on such
  stream and the auto receive toggle will be disabled.
</Note>
...
<img src="/images/legacy/dyn/image-20210322185007725.png" alt="Image 20210322185007725" />
...
<img src="/images/legacy/gh/nodes-create-object.png" alt="Nodes create object" />
...
The same shortcuts apply across those nodes.
...
<Tip>
  You'll find the same functionality for Rhino, which is now covered not by object types but by
  using [Speckle Mapper](/legacy/user/rhino#rhino-mapper).
</Tip>
...
<img
  src="/images/legacy/gh/gh-bim-BuiltElements.png"
  alt="Example of simple floor, wall and level"
/>
...
<img
  src="/images/legacy/gh/gh-bim-be-floor.png"
  alt="Polyline with floor speckle schema attached"
/>
...
<img
  src="/images/legacy/gh/speckle-gh-schema-option.png"
  alt="Schema conversion option for a Beam"
/>
...
<img
  src="/images/legacy/gh/gh-schema-convertOption-nodes.png"
  alt="Difference in conversion methods"
/>
...
<Note>
The *Schema Builder* exists to allow the Grasshopper Connector to read and create *schema objects* from any available kit.
...
<Note>
  Check out our [tutorial on sending data from Grasshopper to
  Revit](https://speckle.systems/tutorials/process-revit-bim-models-in-grasshopper/)!
</Note>
...
<img
  src="/images/legacy/gh/speckle-gh-conversion-createNestedLine.png"
  alt="Creating a Speckle line with custom data attached"
/>
...
<img
  src="/images/legacy/gh/speckle-gh-conversion-send.png"
  alt="Send custom line and normal rhino line"
/>
...
1. Default behavior when receiving data: Automatic conversion to Rhino objects
   <img
     src="/images/legacy/gh/speckle-gh-conversion-expandAndConvert.png"
     alt="Expand and convert"
   />
2. Behavior when "Do not convert" options is enabled: Output is a Speckle Line
   <img
     src="/images/legacy/gh/speckle-gh-conversion-expandAndNoConvert.png"
     alt="Expand but don't convert"
   />
...
<Note>
  Don't worry, we always ensure all objects are converted to Speckle format before preforming a
  `Send` operation.
</Note>

<Warning>
  **Changing document units: If you ever change the units of your Rhino document, make sure you
  recompute the entire Grasshopper definition (press `F5`) to ensure the change is properly
...
<img src="/images/legacy/gh/gh-send-variableinput.gif" alt="Gh send variableinput" />
...
You can find a more detailed explanation of this option [here](#detach-or-do-not-detach).
...
<img src="/images/legacy/gh/gh-receive-variableoutput.gif" alt="Gh receive variableoutput" />
...
<img
  src="/images/legacy/gh/nodes-create-keyval-item.png"
  alt="Creating an object with keys and values as items"
/>

<img
  src="/images/legacy/gh/nodes-create-keyval-list.png"
  alt="Creating an object with keys and values as lists"
/>
...
<Tip>
  **Variable Inputs**: You can add or remove inputs just like you would with the `Create Speckle
  Object` node.
</Tip>
...
- _Values_: The values to assign to each individual key. Works in the same way as the [Create Object by KeyValue node](#create-speckle-object-by-key-value-pairs)
...
<Note>You can also use a stream URL copied from your browser instead of using this node.</Note>
...
<Warning>This node was developed for testing/development purposes.</Warning>
...
<Note>
  For a given layer structure in Rhino you can easily extract the information from all the layers in
  grasshopper
</Note>
