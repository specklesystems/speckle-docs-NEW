...
You can find a more detailed explanation of this option [here](#detach%2Fdo-not-detach).
...
- _Values_: The values to assign to each individual key. Works in the same way as the [Create Object by KeyValue node](#create-speckle-object-by-key%2Fvalue-pairs)
