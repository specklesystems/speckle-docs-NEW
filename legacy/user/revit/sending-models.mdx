...
<img
  src="/images/legacy/revit/create-speckle-project.png"
  alt="Create Speckle Project"
  width={350}
/>
...
<Tip>
  It's not necessary to create a Speckle project every time. You can also select an existing project
  and send data to it.
</Tip>
...
<img
  src="/images/legacy/revit/create-speckle-model.png"
  alt="Create Speckle Model"
  width={700}
  style={{ display: 'block' }}
/>
...
<Tip>Again, you can also select an existing model and send data to it.</Tip>
