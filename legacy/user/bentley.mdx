...
Those products use the same Legacy Speckle connector package.

</Info>

<Note>
  The Speckle connectors for Bentley software were developed by Arup. Huge thanks to them for their
  contribution!
</Note>
...
<Frame>
  <img src="/images/legacy/bentley/speckle-ribbon.png" alt="Speckle ribbon" />
</Frame>
