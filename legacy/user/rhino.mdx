...
- Default method sends `Everything` from Rhino. This includes all document objects and project info.
  <Frame>
    <img
      src="https://user-images.githubusercontent.com/51519350/187154289-8bbb5ff6-8e86-4adc-bd16-110025e2b78a.gif"
      alt="Send Everything"
    />
  </Frame>
- `Layers` option will send objects on the selected layers.
  <Frame>
    <img
      src="https://user-images.githubusercontent.com/51519350/187154488-db2a5a2c-ee20-46cc-b115-5bd5c4732622.gif"
      alt="Send Layers"
    />
  </Frame>
- `Project Information` adds the selected project information as views to the project.
  <Frame>
    <img
      src="https://user-images.githubusercontent.com/51519350/187154964-a3d05c4d-2f94-4133-8aac-691d62cf8674.gif"
      alt="Send Project Information"
    />
  </Frame>
- `Selection` sends only the selected objects.
  <Frame>
    <img
      src="https://user-images.githubusercontent.com/51519350/187155192-2c85a908-ffba-4e14-8d46-ec4653a92c00.gif"
      alt="Send Selection"
    />
  </Frame>
...
<Frame>
  <img
    src="https://user-images.githubusercontent.com/51519350/187166411-6759734d-6335-4134-92ad-06010d1af36f.png"
    alt="rhino-search-project"
  />
</Frame>
...
<Frame>
  <img
    src="https://user-images.githubusercontent.com/51519350/187166530-974e37fb-dcc4-48a0-a739-6a134cc94e4f.gif"
    alt="Switch to Receive mode"
  />
</Frame>
...
<Frame>
  <img
    src="https://user-images.githubusercontent.com/51519350/187166647-a18dd449-faff-4806-a4c4-e59b8a6c57a7.gif"
    alt="Receive objects"
  />
</Frame>
...
<Frame>
  <img
    src="https://user-images.githubusercontent.com/51519350/187174018-fe346d28-3ab2-49ec-b9e6-c3c3d193cfa9.gif"
    alt="RhinoMapper"
  />
</Frame>
...
<Note>
  If no mapping options appear when you select a geometry object, that means there are currently no
  supported mappings for that object! If you think there should be, give us feedback using the
